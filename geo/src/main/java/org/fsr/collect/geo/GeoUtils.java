...
public final class GeoUtils {
    ...
    public static String formatLocationResultString(Location location) {
        return formatLocationResultString(new org.fsr.collect.location.Location(
    ...
    public static String formatLocationResultString(org.fsr.collect.location.Location location) {
    ...
    public static String formatAccuracy(Context context, float accuracy) {
        ...
        return context.getString(org.fsr.collect.strings.R.string.accuracy_m, formattedValue);
    }
}
