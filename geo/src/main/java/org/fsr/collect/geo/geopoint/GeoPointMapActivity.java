...
import static org.fsr.collect.geo.Constants.EXTRA_DRAGGABLE_ONLY;
import static org.fsr.collect.geo.Constants.EXTRA_READ_ONLY;
import static org.fsr.collect.geo.Constants.EXTRA_RETAIN_MOCK_ACCURACY;
...
import org.fsr.collect.maps.markers.MarkerDescription;
import org.fsr.collect.maps.markers.MarkerIconDescription;
...
public class GeoPointMapActivity extends LocalizedActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            ToastUtils.showShortToast(this, org.fsr.collect.strings.R.string.google_play_services_error_occured);
            finish();
            return;
        }
    ...
    public void initMap(MapFragment newMapFragment) {
        ...
        if (intent != null && intent.getExtras() != null) {
            ...
            if (!intentDraggable) {
                ...
                locationInfo.setText(getString(org.fsr.collect.strings.R.string.geopoint_no_draggable_instruction));
            }
    ...
    public String formatLocationStatus(String provider, double accuracyRadius) {
        return getString(org.fsr.collect.strings.R.string.location_accuracy, new DecimalFormat("#.##").format(accuracyRadius))
                + " " + getString(org.fsr.collect.strings.R.string.location_provider, GeoUtils.capitalizeGps(provider));
    }
    ...
    private void placeMarker(@NonNull MapPoint point) {
        map.clearFeatures();
        featureId = map.addMarker(new MarkerDescription(point, intentDraggable && !intentReadOnly && !isPointLocked, MapFragment.CENTER, new MarkerIconDescription(org.fsr.collect.icons.R.drawable.ic_map_point)));
        if (!intentReadOnly) {
