...
public class GeoPolySettingsDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        return new MaterialAlertDialogBuilder(getActivity())
                .setTitle(getString(org.fsr.collect.strings.R.string.input_method))
                .setView(settingsView)
                .setPositiveButton(getString(org.fsr.collect.strings.R.string.start), (dialog, id) -> {
                ...
                .setNegativeButton(org.fsr.collect.strings.R.string.cancel, (dialog, id) -> {
                    dismiss();
                })
                .create();
    }
    ...
    private String formatInterval(int seconds) {
        ...
        return minutes > 0
                ? getResources().getQuantityString(org.fsr.collect.strings.R.plurals.number_of_minutes, minutes, minutes)
                : getResources().getQuantityString(org.fsr.collect.strings.R.plurals.number_of_seconds, seconds, seconds);
    }
    ...
    private String formatAccuracyThreshold(int meters) {
        return meters > 0
                ? getResources().getQuantityString(org.fsr.collect.strings.R.plurals.number_of_meters, meters, meters)
                : getString(org.fsr.collect.strings.R.string.none);
    }
