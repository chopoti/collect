package org.fsr.collect.geo.selection
...
import org.fsr.collect.androidshared.ui.multiclicksafe.setMultiClickSafeOnClickListener
import org.fsr.collect.async.Scheduler
import org.fsr.collect.geo.GeoDependencyComponentProvider
import org.fsr.collect.geo.databinding.SelectionMapLayoutBinding
...
class SelectionMapFragment(
    ...
    override fun onAttach(context: Context) {
        ...
        if (!permissionsChecker.isPermissionGranted(
            ...
            ToastUtils.showLongToast(requireContext(), org.fsr.collect.strings.R.string.not_granted_permission)
    ...
    private fun updateCounts(binding: SelectionMapLayoutBinding) {
        binding.geometryStatus.text = getString(
            org.fsr.collect.strings.R.string.select_item_count,
