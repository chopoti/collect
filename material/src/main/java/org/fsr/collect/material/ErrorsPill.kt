...
class ErrorsPill(context: Context, attrs: AttributeSet?) : MaterialPill(context, attrs) {
    ...
    private fun setup(errors: Boolean) {
        if (errors) {
            ...
            setIcon(org.fsr.collect.icons.R.drawable.ic_baseline_rule_24)
            setText(org.fsr.collect.strings.R.string.draft_errors)
            ...
            visibility = View.VISIBLE
            setIcon(org.fsr.collect.icons.R.drawable.ic_baseline_check_24)
            setText(org.fsr.collect.strings.R.string.draft_no_errors)
