...
import org.fsr.collect.location.R
...
class LocationTrackerService : Service(), LocationClient.LocationClientListener {
    ...
    private fun createNotification(): Notification {
        val notification = NotificationCompat.Builder(this, NOTIFICATION_CHANNEL)
            ...
            .setContentTitle(getLocalizedString(org.fsr.collect.strings.R.string.location_tracking_notification_title))
    ...
    private fun setupNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val notificationChannel = NotificationChannel(
                ...
                getLocalizedString(org.fsr.collect.strings.R.string.location_tracking_notification_channel_name),
