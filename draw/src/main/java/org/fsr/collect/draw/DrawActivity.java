...
import org.fsr.collect.androidshared.bitmap.ImageFileUtils;
...
public class DrawActivity extends LocalizedActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (OPTION_SIGNATURE.equals(loadOption)) {
            alertTitleString = getString(org.fsr.collect.strings.R.string.quit_application,
                    getString(org.fsr.collect.strings.R.string.sign_button));
        } else if (OPTION_ANNOTATE.equals(loadOption)) {
            alertTitleString = getString(org.fsr.collect.strings.R.string.quit_application,
                    getString(org.fsr.collect.strings.R.string.markup_image));
        } else {
            alertTitleString = getString(org.fsr.collect.strings.R.string.quit_application,
                    getString(org.fsr.collect.strings.R.string.draw_image));
        }
    ...
    private void createQuitDrawDialog() {
        int dividerHeight = getResources().getDimensionPixelSize(org.fsr.collect.androidshared.R.dimen.margin_extra_small);
        ...
        items = Arrays.asList(new IconMenuListAdapter.IconMenuItem(org.fsr.collect.icons.R.drawable.ic_save, org.fsr.collect.strings.R.string.keep_changes),
                new IconMenuListAdapter.IconMenuItem(org.fsr.collect.icons.R.drawable.ic_delete, org.fsr.collect.strings.R.string.discard_changes));
        ...
        actionListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (item.getTextResId() == org.fsr.collect.strings.R.string.keep_changes) {
        ...
        alertDialog = new MaterialAlertDialogBuilder(this)
                ...
                .setPositiveButton(getString(org.fsr.collect.strings.R.string.do_not_exit), null)
