package org.fsr.collect.android.formmanagement.metadata

import org.hamcrest.MatcherAssert.assertThat
import org.hamcrest.Matchers.equalTo
import org.junit.Test
import org.fsr.collect.android.formmanagement.metadata.FormMetadataParser.readMetadata
    ...
    fun readMetadata_withGeopointsAtTopLevel_returnsGeopointXPathThatBelongsToSetgeopointActionIfItIsTheFirstOne() {
        val formMetadata = readMetadata(
            """
                ...
                <h:html xmlns:h="http://www.w3.org/1999/xhtml"
                        xmlns="http://www.w3.org/2002/xforms"
                        xmlns:fsr="http://www.opendatakit.org/xforms">
                    <h:head>
                        <h:title>Two geopoints</h:title>
                        <model>
                            <instance>
                            ...
                            <bind nodeset="/data/name" type="string" />
                            <bind nodeset="/data/location2" type="geopoint" />
                            <fsr:setgeopoint ref="/data/location1" event="fsr-instance-first-load"/>
                        </model>
                    </h:head>
                    <h:body>
                        <input ref="/data/name">
