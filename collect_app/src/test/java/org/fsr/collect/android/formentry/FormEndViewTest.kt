...
class FormEndViewTest {
    ...
    fun `form title is displayed correctly`() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(
                    org.fsr.collect.strings.R.string.save_enter_data_description,
                    "blah"
                )
            )
        )
    ...
    fun `when form should not be sent automatically then 'Finalize' button should be displayed`() {
        ...
        assertThat(
            ...
            equalTo(context.getString(org.fsr.collect.strings.R.string.finalize))
        )
    }
    ...
    fun `when form should be sent automatically then 'Send' button should be displayed`() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(
                    org.fsr.collect.strings.R.string.send
                )
            )
        )
    }
    ...
    fun `when only 'Finalize' button is visible display the warning with an appropriate message`() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(
                    org.fsr.collect.strings.R.string.form_edits_warning_title
                )
            )
        )
        assertThat(
            ...
            equalTo(
                context.getString(
                    org.fsr.collect.strings.R.string.form_edits_warning_learn_more
                )
            )
        )
    }
    ...
    fun `when 'Save as draft' and 'Finalize' buttons are visible display the warning with an appropriate message`() {
        ...
        assertThat(
            view.findViewById<MaterialTextView>(R.id.form_edits_warning_message).text.toString(),
            equalTo(
                "${context.getString(org.fsr.collect.strings.R.string.form_edits_warning_message)} ${context.getString(org.fsr.collect.strings.R.string.form_edits_warning_learn_more)}"
            )
        )
    }
    ...
    fun `when 'Save as draft' and 'Send' buttons are visible display the warning with an appropriate message`() {
        ...
        assertThat(
            ...
            equalTo(
                context.getString(
                    org.fsr.collect.strings.R.string.form_edits_warning_title_auto_send_enabled
                )
            )
        )
        assertThat(
