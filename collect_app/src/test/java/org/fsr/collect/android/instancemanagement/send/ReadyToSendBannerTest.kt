...
import org.fsr.collect.shared.TimeInMs
...
class ReadyToSendBannerTest {
    ...
    fun `the banner should display how long ago in seconds the last instance was sent if it was less than a minute ago`() {
        ...
        assertThat(
            ...
            equalTo(context.resources.getQuantityString(org.fsr.collect.strings.R.plurals.last_form_sent_seconds_ago, 5, 5))
        )
    }
    ...
    fun `the banner should display how long ago in minutes the last instance was sent if it was less than an hour ago`() {
        ...
        assertThat(
            view.findViewById<MaterialTextView>(R.id.title).text,
            equalTo(context.resources.getQuantityString(org.fsr.collect.strings.R.plurals.last_form_sent_minutes_ago, 1, 1))
        )
    }
    ...
    fun `the banner should display how long ago in hours the last instance was sent if it was less than a day ago`() {
        ...
        assertThat(
            view.findViewById<MaterialTextView>(R.id.title).text,
            equalTo(context.resources.getQuantityString(org.fsr.collect.strings.R.plurals.last_form_sent_hours_ago, 2, 2))
        )
    }
    ...
    fun `the banner should display how long ago in days the last instance was sent if it was more than 24 hours ago`() {
        ...
        assertThat(
            view.findViewById<MaterialTextView>(R.id.title).text,
            equalTo(context.resources.getQuantityString(org.fsr.collect.strings.R.plurals.last_form_sent_days_ago, 34, 34))
        )
    }
    ...
    fun `the banner should display the number of instances ready to send`() {
        ...
        assertThat(
            ...
            equalTo(context.resources.getQuantityString(org.fsr.collect.strings.R.plurals.forms_ready_to_send, 3, 3))
        )
    }
}
