package org.fsr.collect.android.external
...
import org.fsr.collect.formstest.InMemSavepointsRepository
import org.fsr.collect.projects.InMemProjectsRepository
...
class FormUriActivityTest {
    ...
    fun `When there are no projects then display alert dialog`() {
        ...
        assertErrorDialogAndClickCancelButton(
            scenario,
            context.getString(org.fsr.collect.strings.R.string.app_not_configured)
        )
    }
    ...
    fun `When there is project id specified in uri but it is not the currently used project then display alert dialog`() {
        ...
        assertErrorDialogAndClickCancelButton(
            scenario,
            context.getString(org.fsr.collect.strings.R.string.wrong_project_selected_for_form)
        )
    }
    ...
    fun `When uri is null then display alert dialog`() {
        ...
        assertErrorDialogAndClickCancelButton(
            scenario,
            context.getString(org.fsr.collect.strings.R.string.unrecognized_uri)
        )
    }
    ...
    fun `When uri represents a blank form that does not exist then display alert dialog`() {
        ...
        assertErrorDialogAndClickCancelButton(scenario, context.getString(org.fsr.collect.strings.R.string.bad_uri))
    }
    ...
    fun `When attempting to edit a form with non existing instance file then display alert dialog and remove the instance from the database`() {
        ...
        assertErrorDialogAndClickCancelButton(
            scenario,
            context.getString(org.fsr.collect.strings.R.string.instance_deleted_message)
        )
    }
    ...
    fun `When attempting to edit a form with zero form definitions then display alert dialog with formId if version does not exist`() {
        ...
        val expectedMessage = context.getString(
            org.fsr.collect.strings.R.string.parent_form_not_present,
            instance.formId
        )
    ...
    fun `When attempting to edit a form with zero form definitions then display alert dialog with formId and version if both exist`() {
        ...
        val expectedMessage = context.getString(
            org.fsr.collect.strings.R.string.parent_form_not_present,
            "${instance.formId}\n${
                context.getString(org.fsr.collect.strings.R.string.version)
    ...
    fun `When attempting to edit a form with multiple form definitions then display alert dialog`() {
        ...
        assertErrorDialogAndClickCancelButton(
            scenario,
            context.getString(org.fsr.collect.strings.R.string.survey_multiple_forms_error)
        )
    }
    ...
    fun `When attempting to edit an encrypted form then display alert dialog`() {
        ...
        assertErrorDialogAndClickCancelButton(
            scenario,
            context.getString(org.fsr.collect.strings.R.string.encrypted_form)
        )
    }
    ...
    fun `If there is a savepoint for older version of the blank form, display a recovery dialog and start the old version of the blank form if a user accepts`() {
        ...
        assertSavepointRecoveryDialog(savepointFile)
        onView(withText(org.fsr.collect.strings.R.string.recover)).perform(click())
    ...
    fun `If there is a savepoint for older version of the blank form, display a recovery dialog and start the new version of the blank form if a user declines`() {
        ...
        assertSavepointRecoveryDialog(savepointFile)
        onView(withText(org.fsr.collect.strings.R.string.do_not_recover)).perform(click())
        fakeScheduler.flush()
    ...
    private fun assertSavepointRecoveryDialog(savepointFile: File) {
        onView(withText(org.fsr.collect.strings.R.string.savepoint_recovery_dialog_title)).inRoot(isDialog()).check(matches(isDisplayed()))
        onView(withText(SimpleDateFormat(context.getString(org.fsr.collect.strings.R.string.savepoint_recovery_dialog_message), Locale.getDefault()).format(savepointFile.lastModified()))).inRoot(isDialog()).check(matches(isDisplayed()))
        onView(withText(org.fsr.collect.strings.R.string.recover)).inRoot(isDialog()).check(matches(isDisplayed()))
        onView(withText(org.fsr.collect.strings.R.string.do_not_recover)).inRoot(isDialog()).check(matches(isDisplayed()))
    }
