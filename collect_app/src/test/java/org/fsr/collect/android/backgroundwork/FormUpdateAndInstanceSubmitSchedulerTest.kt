...
import org.fsr.collect.android.TestSettingsProvider
import org.fsr.collect.async.Scheduler
import org.fsr.collect.settings.enums.FormUpdateMode.MATCH_EXACTLY
import org.fsr.collect.settings.enums.FormUpdateMode.PREVIOUSLY_DOWNLOADED_ONLY
import org.fsr.collect.settings.keys.ProjectKeys
import org.fsr.collect.settings.keys.ProjectKeys.KEY_FORM_UPDATE_MODE
import org.fsr.collect.settings.keys.ProjectKeys.KEY_PERIODIC_FORM_UPDATES_CHECK
...
class FormUpdateAndInstanceSubmitSchedulerTest {
    ...
    fun `scheduleUpdates passes project id when scheduling previously downloaded only`() {
        ...
        generalSettings.save(
            ...
            application.getString(org.fsr.collect.strings.R.string.every_one_hour_value)
        )
