...
import static org.fsr.collect.android.utilities.ApplicationConstants.RequestCodes.GEOSHAPE_CAPTURE;
import static org.fsr.collect.android.utilities.ApplicationConstants.RequestCodes.GEOTRACE_CAPTURE;
import static org.fsr.collect.android.utilities.ApplicationConstants.RequestCodes.LOCATION_CAPTURE;
...
public class ActivityGeoDataRequesterTest {
    ...
    public void requestGeoPoint_whenWidgetHasAllowMockAccuracy_addsItToIntent() {
        when(prompt.getBindAttributes())
                .thenReturn(asList(TreeElement.constructAttributeElement("fsr", "allow-mock-accuracy", "true")));
        ...
        when(prompt.getBindAttributes())
                .thenReturn(asList(TreeElement.constructAttributeElement("fsr", "allow-mock-accuracy", "false")));
