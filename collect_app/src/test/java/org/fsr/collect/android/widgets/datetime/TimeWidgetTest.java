...
public class TimeWidgetTest {
    ...
    public void whenPromptIsNotReadOnly_buttonShowsCorrectText() {
        ...
        assertEquals(widget.binding.timeButton.getText(), widget.getContext().getString(org.fsr.collect.strings.R.string.select_time));
    }
    ...
    public void whenPromptDoesNotHaveAnswer_answerTextViewShowsNoTimeSelected() {
        TimeWidget widget = createWidget(promptWithQuestionDefAndAnswer(questionDef, null));
        assertEquals(widget.binding.timeAnswerText.getText(), widget.getContext().getString(org.fsr.collect.strings.R.string.no_time_selected));
    }
