...
public class FileUtilsTest {
    ...
    public void simplifyScopedStoragePathTest() {
        ...
        assertThat(FileUtils.expandAndroidStoragePath("/storage/emulated/0/Android/data/org.fsr.collect.android/files/layers"), is("/sdcard/Android/data/org.fsr.collect.android/files/layers"));
        assertThat(FileUtils.expandAndroidStoragePath("/storage/emulated/0/Android/data/org.fsr.collect.android/files/layers/countries/countries-raster.mbtiles"), is("/sdcard/Android/data/org.fsr.collect.android/files/layers/countries/countries-raster.mbtiles"));
    }
