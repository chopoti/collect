...
import org.fsr.collect.android.TestSettingsProvider.getSettingsProvider
import org.fsr.collect.android.formentry.FormEntryMenuProvider.FormEntryMenuClickListener
...
class FormEntryMenuProviderTest {
    ...
    fun onPrepare_whenBackgroundRecodingEnabled_checksRecordAudio() {
        ...
        assertThat(menu.findItem(R.id.menu_record_audio).title, equalTo(activity.getLocalizedString(org.fsr.collect.strings.R.string.record_audio_on)))
    }
    ...
    fun onPrepare_whenNotRecordingInBackground_unchecksRecordAudio() {
        ...
        assertThat(menu.findItem(R.id.menu_record_audio).title, equalTo(activity.getLocalizedString(org.fsr.collect.strings.R.string.record_audio_off)))
    }
