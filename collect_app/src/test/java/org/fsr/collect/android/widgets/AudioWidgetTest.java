...
import org.fsr.collect.android.widgets.support.FakeQuestionMediaManager;
import org.fsr.collect.android.widgets.utilities.AudioFileRequester;
...
import org.fsr.collect.android.widgets.utilities.RecordingStatusHandler;
...
import static org.fsr.collect.testshared.RobolectricHelpers.setupMediaPlayerDataSource;
...
public class AudioWidgetTest {
    ...
    /**
     * Currently choosing audio is locked into the {@link org.fsr.collect.android.tasks.MediaLoadingTask}
     * flow and so we'd need to rip this apart to let us drop support for accepting File as data. In
     * this case it will just grab the name off the file and use {@link org.fsr.collect.android.utilities.QuestionMediaManager}
