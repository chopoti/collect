...
import org.fsr.collect.android.activities.CrashHandlerActivity
...
class MainMenuActivityTest {
    ...
    fun `Fill Blank Form button should have proper text`() {
        ...
        scenario.onActivity { activity: MainMenuActivity ->
            ...
            assertThat(button.text, `is`(activity.getString(org.fsr.collect.strings.R.string.enter_data)))
        }
    }
    ...
    fun `Edit Saved Form button should have proper text`() {
        ...
        scenario.onActivity { activity: MainMenuActivity ->
            ...
            assertThat(button.text, `is`(activity.getString(org.fsr.collect.strings.R.string.review_data)))
        }
    }
    ...
    fun `Send Finalized Form button should have proper text`() {
        ...
        scenario.onActivity { activity: MainMenuActivity ->
            ...
            assertThat(button.text, `is`(activity.getString(org.fsr.collect.strings.R.string.send_data)))
        }
    }
    ...
    fun `View Sent Form button should have proper text`() {
        ...
        scenario.onActivity { activity: MainMenuActivity ->
            ...
            assertThat(button.text, `is`(activity.getString(org.fsr.collect.strings.R.string.view_sent_forms)))
        }
    }
    ...
    fun `Get Blank Form button should have proper text`() {
        ...
        scenario.onActivity { activity: MainMenuActivity ->
            ...
            assertThat(button.text, `is`(activity.getString(org.fsr.collect.strings.R.string.get_forms)))
        }
    }
    ...
    fun `Delete Saved Form button should have proper text`() {
        ...
        scenario.onActivity { activity: MainMenuActivity ->
            ...
            assertThat(button.text, `is`(activity.getString(org.fsr.collect.strings.R.string.manage_files)))
        }
    }
