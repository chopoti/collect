...
import org.fsr.collect.android.TestSettingsProvider.getProtectedSettings
import org.fsr.collect.android.TestSettingsProvider.getUnprotectedSettings
...
class QRCodeViewModelTest {
    ...
    fun warning_whenServerAndAdminPasswordSet_isForBoth() {
        ...
        assertThat(viewModel.warning.value, equalTo(org.fsr.collect.strings.R.string.qrcode_with_both_passwords))
    }
