...
import static org.fsr.collect.androidtest.LiveDataTestUtilsKt.getOrAwaitValue;
...
import org.fsr.collect.android.javarosawrapper.FakeFormController;
...
public class FormEntryViewModelTest {
    ...
    public void moveForward_whenThereIsAFailedConstraint_setsFailedConstraint() {
        Consumable<FailedValidationResult> failedValidationResult =
                new Consumable<>(new FailedValidationResult(startingIndex, 0, null, org.fsr.collect.strings.R.string.invalid_answer_error));
    ...
    public void moveForward_whenThereIsAFailedConstraint_doesNotFlushAuditLog() throws Exception {
        FailedValidationResult failedValidationResult = new FailedValidationResult(startingIndex, 0, null, org.fsr.collect.strings.R.string.invalid_answer_error);
