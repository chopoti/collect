...
import org.fsr.collect.android.widgets.interfaces.GeoDataRequester;
import org.fsr.collect.android.widgets.utilities.GeoWidgetUtils;
...
import static org.fsr.collect.android.widgets.support.GeoWidgetHelpers.getRandomDoubleArray;
...
import static org.fsr.collect.android.widgets.support.QuestionWidgetHelpers.promptWithReadOnlyAndAnswer;
...
public class GeoPointMapWidgetTest {
    ...
    public void creatingWidgetWithInvalidValue_doesNotUpdateWidgetDisplayedAnswer() {
        ...
        assertEquals(widget.binding.simpleButton.getText(), widget.getContext().getString(org.fsr.collect.strings.R.string.get_point));
    }
    ...
    public void whenPromptIsReadOnlyAndHasAnswer_viewGeoPointButtonIsShown() {
        ...
        assertEquals(widget.binding.simpleButton.getText(), widget.getContext().getString(org.fsr.collect.strings.R.string.view_point));
    }
    ...
    public void whenPromptIsNotReadOnlyAndHasAnswer_viewOrChangeLocationButtonIsShown() {
        GeoPointMapWidget widget = createWidget(promptWithAnswer(answer));
        assertEquals(widget.binding.simpleButton.getText(), widget.getContext().getString(org.fsr.collect.strings.R.string.view_or_change_point));
    }
