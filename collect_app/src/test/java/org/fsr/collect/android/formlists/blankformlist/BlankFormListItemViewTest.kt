...
class BlankFormListItemViewTest {
    ...
    fun `displays form version`() {
        ...
        assertThat(
            ...
            equalTo(context.getString(org.fsr.collect.strings.R.string.version_number, "myVersion"))
        )
    }
    ...
    fun `displays form id`() {
        ...
        assertThat(
            ...
            equalTo(context.getString(org.fsr.collect.strings.R.string.id_number, "myId"))
        )
    }
}
