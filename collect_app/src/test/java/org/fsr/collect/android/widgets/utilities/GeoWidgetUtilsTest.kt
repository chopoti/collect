...
import org.fsr.collect.android.widgets.support.GeoWidgetHelpers
import org.fsr.collect.android.widgets.utilities.GeoWidgetUtils.convertCoordinatesIntoDegreeFormat
import org.fsr.collect.android.widgets.utilities.GeoWidgetUtils.floor
import org.fsr.collect.android.widgets.utilities.GeoWidgetUtils.getGeoPointAnswerToDisplay
import org.fsr.collect.android.widgets.utilities.GeoWidgetUtils.getGeoPolyAnswerToDisplay
import org.fsr.collect.android.widgets.utilities.GeoWidgetUtils.isWithinMapBounds
import org.fsr.collect.android.widgets.utilities.GeoWidgetUtils.parseGeometry
import org.fsr.collect.android.widgets.utilities.GeoWidgetUtils.parseGeometryPoint
import org.fsr.collect.android.widgets.utilities.GeoWidgetUtils.truncateDouble
...
class GeoWidgetUtilsTest {
    ...
    fun getAnswerToDisplay_whenAnswerIsNotNullAndConvertible_returnsAnswer() {
        ...
        assertEquals(
            ...
            context.getString(
                org.fsr.collect.strings.R.string.gps_result,
