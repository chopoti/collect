...
import org.fsr.collect.android.javarosawrapper.InstanceMetadata;
...
import org.fsr.collect.testshared.ErrorIntentLauncher;
...
public class OSMWidgetTest {
    ...
    public void whenPromptHasAnswer_widgetShowsCorrectAnswer() {
        ...
        assertThat(widget.binding.errorText.getVisibility(), is(View.GONE));
        assertThat(widget.binding.osmFileHeaderText.getText(), is(widgetActivity.getString(org.fsr.collect.strings.R.string.edited_osm_file)));
    ...
    public void whenPromptHasAnswer_recaptureOsmButtonIsDisplayed() {
        OSMWidget widget = createWidget(promptWithAnswer(new StringData("blah")));
        assertThat(widget.binding.launchOpenMapKitButton.getText(), is(widgetActivity.getString(org.fsr.collect.strings.R.string.recapture_osm)));
    }
    ...
    public void clearAnswer_showsCaptureOsmButton() {
        OSMWidget widget = createWidget(promptWithAnswer(new StringData("blah")));
        widget.clearAnswer();
        assertThat(widget.binding.launchOpenMapKitButton.getText(), is(widgetActivity.getString(org.fsr.collect.strings.R.string.capture_osm)));
    }
