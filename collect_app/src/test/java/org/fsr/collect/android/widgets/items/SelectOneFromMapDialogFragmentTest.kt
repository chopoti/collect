...
import org.fsr.collect.android.widgets.items.SelectOneFromMapDialogFragment.Companion.ARG_FORM_INDEX
import org.fsr.collect.android.widgets.items.SelectOneFromMapDialogFragment.Companion.ARG_SELECTED_INDEX
import org.fsr.collect.android.widgets.support.FormElementFixtures.selectChoice
import org.fsr.collect.android.widgets.support.FormElementFixtures.treeElement
                ...
                equalTo(
                    listOf(
                        MappableSelectItem.MappableSelectPoint(
                            ...
                            smallIcon = org.fsr.collect.icons.R.drawable.ic_map_marker_with_hole_small,
                            largeIcon = org.fsr.collect.icons.R.drawable.ic_map_marker_with_hole_big,
                            action = IconifiedText(
                                org.fsr.collect.icons.R.drawable.ic_save,
                                application.getString(org.fsr.collect.strings.R.string.select_item)
                            )
                        ),
                        MappableSelectItem.MappableSelectPoint(
                            1,
