...
class MediaUtilsTest {
    ...
    fun `When open file, launch on intentLauncher should be called with proper parameters`() {
        ...
        whenever(
            ...
            Uri.parse("content://org.fsr.collect.android.provider/external_files/Android/data/org.fsr.collect.android/files/image.png")
        )
        ...
        assertThat(
            ...
            `is`("content://org.fsr.collect.android.provider/external_files/Android/data/org.fsr.collect.android/files/image.png")
        )
