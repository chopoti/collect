...
import org.fsr.collect.android.databinding.ImageWidgetBinding;
...
import org.fsr.collect.selfiecamera.CaptureSelfieActivity;
...
public class ImageWidget extends BaseImageWidget {
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        binding.chooseButton.setOnClickListener(v -> imageCaptureHandler.chooseImage(org.fsr.collect.strings.R.string.choose_image));
    ...
    private void captureImage() {
        if (selfie && new CameraUtils().isFrontCameraAvailable(getContext())) {
            ...
            imageCaptureHandler.captureImage(intent, RequestCodes.MEDIA_FILE_PATH, org.fsr.collect.strings.R.string.capture_image);
        } else {
            Intent intent = ImageCaptureIntentCreator.imageCaptureIntent(getFormEntryPrompt(), getContext(), tmpImageFilePath);
            imageCaptureHandler.captureImage(intent, RequestCodes.IMAGE_CAPTURE, org.fsr.collect.strings.R.string.capture_image);
        }
    }
}
