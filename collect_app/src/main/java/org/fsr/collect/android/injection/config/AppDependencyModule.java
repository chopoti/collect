...
import static org.fsr.collect.androidshared.data.AppStateKt.getState;
import static org.fsr.collect.settings.keys.MetaKeys.KEY_INSTALL_ID;
...
import org.fsr.collect.analytics.BlockableFirebaseAnalytics;
import org.fsr.collect.analytics.NoopAnalytics;
import org.fsr.collect.android.BuildConfig;
import org.fsr.collect.android.R;
import org.fsr.collect.android.application.CollectSettingsChangeHandler;
import org.fsr.collect.android.application.MapboxClassInstanceCreator;
import org.fsr.collect.android.application.initialization.AnalyticsInitializer;
...
import org.fsr.collect.android.application.initialization.MapsInitializer;
...
import org.fsr.collect.android.backgroundwork.FormUpdateAndInstanceSubmitScheduler;
...
import org.fsr.collect.android.configure.qr.CachingQRCodeGenerator;
import org.fsr.collect.android.configure.qr.QRCodeGenerator;
import org.fsr.collect.android.database.itemsets.DatabaseFastExternalItemsetsRepository;
...
import org.fsr.collect.android.formentry.AppStateFormSessionRepository;
...
import org.fsr.collect.android.formentry.media.ScreenContextAudioHelperFactory;
import org.fsr.collect.android.formlists.blankformlist.BlankFormListViewModel;
import org.fsr.collect.android.formmanagement.CollectFormEntryControllerFactory;
...
import org.fsr.collect.android.geo.MapFragmentFactoryImpl;
...
import org.fsr.collect.android.instancemanagement.send.ReadyToSendViewModel;
import org.fsr.collect.android.itemsets.FastExternalItemsetsRepository;
import org.fsr.collect.android.mainmenu.MainMenuViewModelFactory;
...
import org.fsr.collect.android.openrosa.CollectThenSystemContentTypeMapper;
...
import org.fsr.collect.android.preferences.Defaults;
import org.fsr.collect.android.preferences.PreferenceVisibilityHandler;
import org.fsr.collect.android.preferences.ProjectPreferencesViewModel;
import org.fsr.collect.android.preferences.source.SharedPreferencesSettingsProvider;
import org.fsr.collect.android.projects.ProjectCreator;
...
import org.fsr.collect.android.utilities.AdminPasswordProvider;
import org.fsr.collect.android.utilities.AndroidUserAgent;
...
import org.fsr.collect.android.utilities.ContentUriProvider;
...
import org.fsr.collect.androidshared.bitmap.ImageCompressor;
import org.fsr.collect.androidshared.system.IntentLauncher;
import org.fsr.collect.androidshared.system.IntentLauncherImpl;
import org.fsr.collect.androidshared.utils.ScreenUtils;
import org.fsr.collect.async.CoroutineAndWorkManagerScheduler;
import org.fsr.collect.async.Scheduler;
import org.fsr.collect.async.network.ConnectivityProvider;
import org.fsr.collect.async.network.NetworkStateProvider;
import org.fsr.collect.audiorecorder.recording.AudioRecorder;
import org.fsr.collect.audiorecorder.recording.AudioRecorderFactory;
...
import org.fsr.collect.location.GoogleFusedLocationClient;
import org.fsr.collect.location.LocationClient;
import org.fsr.collect.location.LocationClientProvider;
import org.fsr.collect.maps.MapFragmentFactory;
import org.fsr.collect.maps.layers.DirectoryReferenceLayerRepository;
import org.fsr.collect.maps.layers.ReferenceLayerRepository;
import org.fsr.collect.metadata.InstallIDProvider;
import org.fsr.collect.metadata.PropertyManager;
import org.fsr.collect.metadata.SettingsInstallIDProvider;
...
import org.fsr.collect.projects.SharedPreferencesProjectsRepository;
import org.fsr.collect.qrcode.QRCodeCreatorImpl;
import org.fsr.collect.qrcode.QRCodeDecoder;
import org.fsr.collect.qrcode.QRCodeDecoderImpl;
...
import org.fsr.collect.settings.keys.AppConfigurationKeys;
