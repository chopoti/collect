...
import org.fsr.collect.android.databinding.AudioWidgetAnswerBinding;
...
import org.fsr.collect.android.widgets.interfaces.FileWidget;
...
import static org.fsr.collect.strings.format.LengthFormatterKt.formatLength;
            ...
            binding.audioPlayer.audioController.setListener(new AudioControllerView.Listener() {
                ...
                public void onRemoveClicked() {
                    new MaterialAlertDialogBuilder(getContext())
                            .setTitle(org.fsr.collect.strings.R.string.delete_answer_file_question)
                            .setMessage(org.fsr.collect.strings.R.string.answer_file_delete_warning)
                            .setPositiveButton(org.fsr.collect.strings.R.string.delete_answer_file, (dialog, which) -> clearAnswer())
