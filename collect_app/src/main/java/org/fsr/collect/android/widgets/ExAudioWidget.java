...
import org.fsr.collect.android.databinding.ExAudioWidgetAnswerBinding;
    ...
    public void setData(Object object) {
        ...
        if (object instanceof File && mediaUtils.isAudioFile((File) object)) {
            ...
            if (object instanceof File) {
                ToastUtils.showLongToast(getContext(), org.fsr.collect.strings.R.string.invalid_file_type);
