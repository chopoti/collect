...
import org.fsr.collect.android.databinding.DrawWidgetBinding;
...
public class DrawWidget extends BaseImageWidget {
    ...
    public DrawWidget(Context context, QuestionDetails prompt, QuestionMediaManager questionMediaManager, WaitingForDataRegistry waitingForDataRegistry, String tmpImageFilePath) {
        ...
        imageClickHandler = new DrawImageClickHandler(DrawActivity.OPTION_DRAW, RequestCodes.DRAW_IMAGE, org.fsr.collect.strings.R.string.draw_image);
    ...
    public void clearAnswer() {
        super.clearAnswer();
        binding.drawButton.setText(getContext().getString(org.fsr.collect.strings.R.string.draw_image));
    }
