...
/**
 * @deprecated Use
 * {@link org.fsr.collect.androidshared.system.ContextUtils#getThemeAttributeValue(Context, int)}
 * intead.
 */
@Deprecated
public final class ThemeUtils {
    ...
    public boolean isSystemTheme() {
        return getPrefsTheme().equals(context.getString(org.fsr.collect.strings.R.string.app_theme_system));
    }
    ...
    public boolean isDarkTheme() {
        if (isSystemTheme()) {
            ...
            return theme.equals(context.getString(org.fsr.collect.strings.R.string.app_theme_dark));
        }
    }
