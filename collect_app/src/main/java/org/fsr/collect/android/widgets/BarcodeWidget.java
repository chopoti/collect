...
import static org.fsr.collect.android.utilities.Appearances.FRONT;
...
import org.fsr.collect.android.activities.ScannerWithFlashlightActivity;
import org.fsr.collect.android.databinding.BarcodeWidgetAnswerBinding;
...
public class BarcodeWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        if (answer != null && !answer.isEmpty()) {
            binding.barcodeButton.setText(getContext().getString(org.fsr.collect.strings.R.string.replace_barcode));
    ...
    public void clearAnswer() {
        ...
        binding.barcodeButton.setText(getContext().getString(org.fsr.collect.strings.R.string.get_barcode));
        widgetValueChanged();
    ...
    private void setCameraIdIfNeeded(FormEntryPrompt prompt, IntentIntegrator intent) {
        if (Appearances.isFrontCameraAppearance(prompt)) {
            if (cameraUtils.isFrontCameraAvailable(getContext())) {
                ...
                ToastUtils.showLongToast(getContext(), org.fsr.collect.strings.R.string.error_front_camera_unavailable);
            }
        }
    }
}
