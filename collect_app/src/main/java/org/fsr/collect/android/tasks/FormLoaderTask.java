...
import static org.fsr.collect.android.utilities.FormUtils.setupReferenceManagerForForm;
...
import org.fsr.collect.android.dynamicpreload.ExternalDataUseCases;
...
import org.fsr.collect.android.utilities.ExternalizableFormDefCache;
...
import org.fsr.collect.android.utilities.ZipUtils;
import org.fsr.collect.async.Scheduler;
import org.fsr.collect.async.SchedulerAsyncTaskMimic;
import org.fsr.collect.entities.javarosa.spec.UnrecognizedEntityVersionException;
...
public class FormLoaderTask extends SchedulerAsyncTaskMimic<Void, String, FormLoaderTask.FECWrapper> {
    ...
    protected FECWrapper doInBackground(Void... ignored) {
        ...
        try {
            ...
            Timber.e(e);
            errorMsg = getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.too_complex_form);
        } catch (UnrecognizedEntityVersionException e) {
            errorMsg = getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.unrecognized_entity_version, e.getEntityVersion());
        } catch (Exception e) {
            Timber.w(e);
    ...
    private FormDef createFormDefFromCacheOrXml(String formPath, File formXml) throws XFormParser.ParseException {
        publishProgress(
                getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.survey_loading_reading_form_message));
        ...
        if (instancePath != null) {
            ...
            if (instanceXml.exists()) {
                ...
                try {
                    ...
                    publishProgress(getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.survey_loading_reading_data_message));
