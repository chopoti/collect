...
fun getInstanceIcon(status: String): Int {
    return when (status) {
        Instance.STATUS_INCOMPLETE, Instance.STATUS_INVALID, Instance.STATUS_VALID -> org.fsr.collect.android.R.drawable.ic_form_state_saved
        Instance.STATUS_COMPLETE -> org.fsr.collect.android.R.drawable.ic_form_state_finalized
        Instance.STATUS_SUBMITTED -> org.fsr.collect.android.R.drawable.ic_form_state_submitted
        Instance.STATUS_SUBMISSION_FAILED -> org.fsr.collect.android.R.drawable.ic_form_state_submission_failed
