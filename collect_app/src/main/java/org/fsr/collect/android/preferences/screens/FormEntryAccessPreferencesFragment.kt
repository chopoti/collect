...
import org.fsr.collect.android.fragments.dialogs.MovingBackwardsDialog
            ...
            Preference.OnPreferenceChangeListener { preference: Preference, _: Any? ->
                if ((preference as CheckBoxPreference).isChecked) {
                    ...
                    SimpleDialog.newInstance(
                        requireActivity().getString(org.fsr.collect.strings.R.string.moving_backwards_enabled_title),
                        0,
                        requireActivity().getString(org.fsr.collect.strings.R.string.moving_backwards_enabled_message),
                        requireActivity().getString(org.fsr.collect.strings.R.string.ok),
                        false
                    ).show(
                        requireActivity().supportFragmentManager,
