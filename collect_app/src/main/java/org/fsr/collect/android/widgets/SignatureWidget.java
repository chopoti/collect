...
import org.fsr.collect.android.databinding.SignatureWidgetBinding;
...
public class SignatureWidget extends BaseImageWidget {
    ...
    public SignatureWidget(Context context, QuestionDetails prompt, QuestionMediaManager questionMediaManager, WaitingForDataRegistry waitingForDataRegistry, String tmpImageFilePath) {
        ...
        imageClickHandler = new DrawImageClickHandler(DrawActivity.OPTION_SIGNATURE, RequestCodes.SIGNATURE_CAPTURE, org.fsr.collect.strings.R.string.signature_capture);
    ...
    public void clearAnswer() {
        super.clearAnswer();
        binding.signButton.setText(getContext().getString(org.fsr.collect.strings.R.string.sign_button));
    }
