...
package org.fsr.collect.android.formentry.questions;
...
import org.fsr.collect.android.databinding.AudioVideoImageTextLabelBinding;
...
public class AudioVideoImageTextLabel extends RelativeLayout implements View.OnClickListener {
    ...
    public void setImage(@NonNull File imageFile, ImageLoader imageLoader) {
        if (imageFile.exists()) {
            ...
            binding.missingImage.setText(getContext().getString(org.fsr.collect.strings.R.string.file_missing, imageFile));
        }
    }
