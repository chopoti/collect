package org.fsr.collect.android.database.forms;

import android.database.SQLException;
import android.database.sqlite.SQLiteDatabase;

import org.fsr.collect.db.sqlite.DatabaseMigrator;
import org.fsr.collect.db.sqlite.SQLiteUtils;

import static android.provider.BaseColumns._ID;
import static org.fsr.collect.android.database.DatabaseConstants.FORMS_TABLE_NAME;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.AUTO_DELETE;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.AUTO_SEND;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.BASE64_RSA_PUBLIC_KEY;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.DATE;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.DELETED_DATE;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.DESCRIPTION;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.DISPLAY_NAME;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.DISPLAY_SUBTEXT;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.FORM_FILE_PATH;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.FORM_MEDIA_PATH;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.GEOMETRY_XPATH;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.JRCACHE_FILE_PATH;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.JR_FORM_ID;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.JR_VERSION;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.LANGUAGE;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.LAST_DETECTED_ATTACHMENTS_UPDATE_DATE;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.LAST_DETECTED_FORM_VERSION_HASH;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.MD5_HASH;
import static org.fsr.collect.android.database.forms.DatabaseFormColumns.SUBMISSION_URI;
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion) throws SQLException {
        ...
        switch (oldVersion) {
            ...
            case 12:
                ...
                break;
            case 13:
                // Remember to bump the database version number in {@link org.fsr.collect.android.database.DatabaseConstants}
