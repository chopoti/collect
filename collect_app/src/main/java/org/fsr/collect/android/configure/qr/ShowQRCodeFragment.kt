...
import org.fsr.collect.android.databinding.ShowQrcodeFragmentBinding
...
class ShowQRCodeFragment : Fragment() {
    ...
    private fun passwordWarningClicked() {
        val items = arrayOf(
            getString(org.fsr.collect.strings.R.string.admin_password),
            getString(org.fsr.collect.strings.R.string.server_password)
        )
        MaterialAlertDialogBuilder(requireActivity())
            .setTitle(org.fsr.collect.strings.R.string.include_password_dialog)
            .setMultiChoiceItems(
                items,
                checkedItems
            ...
            .setCancelable(false)
            .setPositiveButton(org.fsr.collect.strings.R.string.generate) { dialog: DialogInterface, _: Int ->
                qrCodeViewModel.setIncludedKeys(
                    selectedPasswordKeys
                )
                dialog.dismiss()
            }
            .setNegativeButton(org.fsr.collect.strings.R.string.cancel) { dialog: DialogInterface, _: Int -> dialog.dismiss() }
            .create()
            .apply {
