...
import org.fsr.collect.android.databinding.FormEntryEndBinding
...
class FormEndView(
    ...
    init {
        binding.description.text = context.getString(org.fsr.collect.strings.R.string.save_enter_data_description, formTitle)
        ...
        if (shouldFormBeSentAutomatically) {
            binding.finalize.text = context.getString(org.fsr.collect.strings.R.string.send)
        }

        if (!binding.saveAsDraft.isVisible && !shouldFormBeSentAutomatically) {
            binding.formEditsWarningTitle.setText(org.fsr.collect.strings.R.string.form_edits_warning_title)
            ...
            if (shouldFormBeSentAutomatically) {
                binding.formEditsWarningTitle.setText(org.fsr.collect.strings.R.string.form_edits_warning_title_auto_send_enabled)
            } else {
                binding.formEditsWarningTitle.setText(org.fsr.collect.strings.R.string.form_edits_warning_title)
            }
            binding.formEditsWarningMessage.apply {
                text = SpannableStringBuilder()
                    .append(context.getLocalizedString(org.fsr.collect.strings.R.string.form_edits_warning_message))
                    .append(" ")
                ...
                inSpans(
                    ...
                    builderAction = {
                        color(ContextUtils.getThemeAttributeValue(context, com.google.android.material.R.attr.colorAccent)) {
                            underline {
                                append(context.getLocalizedString(org.fsr.collect.strings.R.string.form_edits_warning_learn_more))
                            }
                        }
                    }
                )
