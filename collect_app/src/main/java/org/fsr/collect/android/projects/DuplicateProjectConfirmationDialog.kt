...
class DuplicateProjectConfirmationDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            .setTitle(org.fsr.collect.strings.R.string.duplicate_project)
            .setMessage(org.fsr.collect.strings.R.string.duplicate_project_details)
            .setPositiveButton(org.fsr.collect.strings.R.string.add_duplicate_project) { _, _ -> listener.createProject(settingsJson) }
            .setNegativeButton(org.fsr.collect.strings.R.string.switch_to_existing) { _, _ ->
                run {
