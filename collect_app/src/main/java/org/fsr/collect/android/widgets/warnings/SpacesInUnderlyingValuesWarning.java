...
import org.fsr.collect.android.utilities.UnderlyingValuesConcat;
    ...
    private static class SpacesInUnderlyingValuesTextCreator implements WarningTextCreator {
        ...
        public String create(List<SelectChoice> invalidValues, Context context) {
            return context.getResources().getString(
                    invalidValues.size() > 1 ? org.fsr.collect.strings.R.string.invalid_space_in_answer_plural : org.fsr.collect.strings.R.string.invalid_space_in_answer_singular,
