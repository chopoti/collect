...
import org.fsr.collect.android.databinding.GeopointQuestionBinding;
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        if (answerToDisplay.isEmpty()) {
            if (getFormEntryPrompt().isReadOnly()) {
                ...
                binding.simpleButton.setText(org.fsr.collect.strings.R.string.get_point);
            }
            answerText = null;
        } else {
            if (getFormEntryPrompt().isReadOnly()) {
                binding.simpleButton.setText(org.fsr.collect.strings.R.string.view_point);
            } else {
                binding.simpleButton.setText(org.fsr.collect.strings.R.string.view_or_change_point);
            }
