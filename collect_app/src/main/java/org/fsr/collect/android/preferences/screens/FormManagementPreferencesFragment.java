...
import static org.fsr.collect.android.preferences.utilities.PreferencesUtils.displayDisabled;
import static org.fsr.collect.settings.enums.StringIdEnumUtils.getFormUpdateMode;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_AUTOMATIC_UPDATE;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_AUTOSEND;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_CONSTRAINT_BEHAVIOR;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_FORM_UPDATE_MODE;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_GUIDANCE_HINT;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_IMAGE_SIZE;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_PERIODIC_FORM_UPDATES_CHECK;
import static org.fsr.collect.settings.keys.ProtectedProjectKeys.ALLOW_OTHER_WAYS_OF_EDITING_FORM;
...
import org.fsr.collect.settings.enums.AutoSend;
import org.fsr.collect.settings.enums.StringIdEnumUtils;
    ...
    private void initPref(String key) {
        ...
        if (pref != null) {
            if (key.equals(KEY_AUTOMATIC_UPDATE)) {
                ...
                pref.setEnabled(!formUpdateCheckPeriod.equals(getString(org.fsr.collect.strings.R.string.never_value)));
            }
        }
    }
