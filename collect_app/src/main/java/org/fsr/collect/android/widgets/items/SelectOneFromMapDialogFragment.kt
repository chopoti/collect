...
import org.fsr.collect.android.databinding.SelectOneFromMapDialogLayoutBinding
...
import org.fsr.collect.geo.selection.SelectionMapFragment.Companion.REQUEST_SELECT_ITEM
...
internal class SelectChoicesMapData(
                        ...
                        if (withinBounds) {
                            ...
                            if (points.size == 1) {
                                ...
                                list + MappableSelectItem.MappableSelectPoint(
                                    ...
                                    point = points[0],
                                    smallIcon = if (markerSymbol == null) org.fsr.collect.icons.R.drawable.ic_map_marker_with_hole_small else org.fsr.collect.icons.R.drawable.ic_map_marker_small,
                                    largeIcon = if (markerSymbol == null) org.fsr.collect.icons.R.drawable.ic_map_marker_with_hole_big else org.fsr.collect.icons.R.drawable.ic_map_marker_big,
                                    color = markerColor,
                                    symbol = markerSymbol,
                                    action = IconifiedText(
                                        org.fsr.collect.icons.R.drawable.ic_save,
                                        resources.getString(org.fsr.collect.strings.R.string.select_item)
                                    )
                                )
    ...
    override fun getItemType(): String {
        return resources.getString(org.fsr.collect.strings.R.string.choices)
    }
