...
public abstract class BarCodeScannerFragment extends Fragment implements DecoratedBarcodeView.TorchListener {
    ...
    private void startScanning(Bundle savedInstanceState) {
        capture = codeCaptureManagerFactory.getCaptureManager(requireActivity(), barcodeScannerView, savedInstanceState, getSupportedCodeFormats(), getContext().getString(org.fsr.collect.strings.R.string.barcode_scanner_prompt));
        ...
        barcodeViewDecoder.waitForBarcode(barcodeScannerView).observe(getViewLifecycleOwner(), barcodeResult -> {
            ...
            try {
                ...
                ToastUtils.showShortToast(requireContext(), getString(org.fsr.collect.strings.R.string.invalid_qrcode));
            }
        });
    }
    ...
    private void switchFlashlight() {
        if (getString(org.fsr.collect.strings.R.string.turn_on_flashlight).equals(switchFlashlightButton.getText())) {
    ...
    public void onTorchOn() {
        switchFlashlightButton.setText(org.fsr.collect.strings.R.string.turn_off_flashlight);
    }

    @Override
    public void onTorchOff() {
        switchFlashlightButton.setText(org.fsr.collect.strings.R.string.turn_on_flashlight);
    }
