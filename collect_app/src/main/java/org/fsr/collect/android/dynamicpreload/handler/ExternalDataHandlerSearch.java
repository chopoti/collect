...
package org.fsr.collect.android.dynamicpreload.handler;
...
import org.fsr.collect.android.dynamicpreload.ExternalSQLiteOpenHelper;
    ...
    public Object eval(Object[] args, EvaluationContext ec) {
        ...
        try {
            ...
            try {
                ...
                Timber.e(new Error(getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.ext_import_csv_missing_error, dataSetName, dataSetName)));
                c = db.query(ExternalDataUtil.EXTERNAL_DATA_TABLE_NAME, sqlColumns, selection,
