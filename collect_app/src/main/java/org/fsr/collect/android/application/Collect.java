...
import static org.fsr.collect.settings.keys.MetaKeys.KEY_GOOGLE_BUG_154855417_FIXED;
...
import org.fsr.collect.android.dynamicpreload.ExternalDataManager;
...
import org.fsr.collect.android.injection.config.CollectDrawDependencyModule;
import org.fsr.collect.android.injection.config.CollectGeoDependencyModule;
import org.fsr.collect.android.injection.config.CollectGoogleMapsDependencyModule;
import org.fsr.collect.android.injection.config.CollectOsmDroidDependencyModule;
import org.fsr.collect.android.injection.config.CollectProjectsDependencyModule;
import org.fsr.collect.android.injection.config.CollectSelfieCameraDependencyModule;
...
import org.fsr.collect.android.utilities.LocaleHelper;
...
import org.fsr.collect.androidshared.system.ExternalFilesUtils;
...
import org.fsr.collect.draw.DaggerDrawDependencyComponent;
import org.fsr.collect.draw.DrawDependencyComponent;
import org.fsr.collect.draw.DrawDependencyComponentProvider;
import org.fsr.collect.entities.DaggerEntitiesDependencyComponent;
import org.fsr.collect.entities.EntitiesDependencyComponent;
import org.fsr.collect.entities.EntitiesDependencyComponentProvider;
import org.fsr.collect.entities.EntitiesDependencyModule;
...
import org.fsr.collect.googlemaps.DaggerGoogleMapsDependencyComponent;
import org.fsr.collect.googlemaps.GoogleMapsDependencyComponent;
import org.fsr.collect.googlemaps.GoogleMapsDependencyComponentProvider;
import org.fsr.collect.location.LocationClient;
import org.fsr.collect.maps.layers.ReferenceLayerRepository;
import org.fsr.collect.osmdroid.DaggerOsmDroidDependencyComponent;
import org.fsr.collect.osmdroid.OsmDroidDependencyComponent;
import org.fsr.collect.osmdroid.OsmDroidDependencyComponentProvider;
...
import org.fsr.collect.selfiecamera.DaggerSelfieCameraDependencyComponent;
...
import org.fsr.collect.shared.injection.ObjectProvider;
import org.fsr.collect.shared.injection.ObjectProviderHost;
import org.fsr.collect.shared.injection.SupplierObjectProvider;
import org.fsr.collect.shared.settings.Settings;
import org.fsr.collect.shared.strings.Md5;
import org.fsr.collect.strings.localization.LocalizedApplication;
