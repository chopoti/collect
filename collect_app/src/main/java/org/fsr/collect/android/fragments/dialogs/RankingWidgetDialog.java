...
import static org.fsr.collect.android.utilities.ViewUtils.pxFromDp;
...
import org.fsr.collect.android.adapters.RankingListAdapter;
import org.fsr.collect.android.fragments.viewmodels.RankingViewModel;
import org.fsr.collect.android.utilities.RankingItemTouchHelperCallback;
...
public class RankingWidgetDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        return new MaterialAlertDialogBuilder(getActivity())
                ...
                .setPositiveButton(org.fsr.collect.strings.R.string.ok, (dialog, id) -> {
                    listener.onRankingChanged(rankingListAdapter.getItems());
                    dismiss();
                })
                .setNegativeButton(org.fsr.collect.strings.R.string.cancel, (dialog, id) -> dismiss())
                .create();
    }
    ...
    private NestedScrollView setUpRankingLayout() {
        ...
        float standardMargin = requireContext()
                .getResources()
                .getDimension(org.fsr.collect.androidshared.R.dimen.margin_standard);
