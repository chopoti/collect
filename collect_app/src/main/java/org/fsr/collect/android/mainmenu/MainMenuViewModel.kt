...
import org.fsr.collect.android.instancemanagement.InstanceDiskSynchronizer
...
import org.fsr.collect.android.instancemanagement.canBeEdited
import org.fsr.collect.android.instancemanagement.isDraft
    ...
    private fun getFormSavedSnackbarDetails(uri: Uri): Pair<Int, Int?>? {
        ...
        return if (instance != null) {
            val message = if (instance.isDraft()) {
                org.fsr.collect.strings.R.string.form_saved_as_draft
                ...
                if (form.shouldFormBeSentAutomatically(autoSendSettingsProvider.isAutoSendEnabledInSettings())) {
                    org.fsr.collect.strings.R.string.form_sending
                } else {
                    org.fsr.collect.strings.R.string.form_saved
                }
            } else {
                return null
            }
            ...
            val action = if (instance.canBeEdited(settingsProvider)) {
                org.fsr.collect.strings.R.string.edit_form
            } else {
                if (instance.isDraft() || instance.canEditWhenComplete()) {
                    org.fsr.collect.strings.R.string.view_form
                } else {
                    null
                }
            }
