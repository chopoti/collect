...
import org.fsr.collect.android.databinding.VideoWidgetBinding;
...
public class VideoWidget extends QuestionWidget implements FileWidget, WidgetDataReceiver {
    ...
    private void captureVideo() {
        ...
        try {
            ...
            Toast.makeText(
                    getContext(),
                    getContext().getString(org.fsr.collect.strings.R.string.activity_not_found,
                            getContext().getString(org.fsr.collect.strings.R.string.capture_video)), Toast.LENGTH_SHORT)
                    .show();
    ...
    private void chooseVideo() {
        ...
        try {
            ...
            Toast.makeText(
                    getContext(),
                    getContext().getString(org.fsr.collect.strings.R.string.activity_not_found,
                            getContext().getString(org.fsr.collect.strings.R.string.choose_video)), Toast.LENGTH_SHORT)
                    .show();
