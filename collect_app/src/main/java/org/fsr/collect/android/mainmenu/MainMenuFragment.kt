...
import org.fsr.collect.android.databinding.MainMenuBinding
...
import org.fsr.collect.android.projects.ProjectIconView
...
import org.fsr.collect.androidshared.data.consume
...
//        manageGoogleDriveDeprecationBanner(binding)
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        val projectsMenuItem = menu.findItem(org.fsr.collect.android.R.id.projects)
    ...
    override fun onCreateOptionsMenu(menu: Menu, menuInflater: MenuInflater) {
        menuInflater.inflate(org.fsr.collect.android.R.menu.main_menu, menu)
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (item.itemId == org.fsr.collect.android.R.id.projects) {
            DialogFragmentUtils.showIfNotShowing(
    ...
    private fun initToolbar(binding: MainMenuBinding) {
        val toolbar = binding.root.findViewById<Toolbar>(org.fsr.collect.androidshared.R.id.toolbar)
    ...
    private fun initMapbox() {
        if (MapboxClassInstanceCreator.isMapboxAvailable()) {
            childFragmentManager
                .beginTransaction()
                .add(
                    org.fsr.collect.android.R.id.map_box_initialization_fragment,
