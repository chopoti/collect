...
import org.fsr.collect.android.activities.viewmodels.FormDownloadListViewModel;
import org.fsr.collect.android.adapters.FormDownloadListAdapter;
import org.fsr.collect.android.formentry.RefreshFormListDialogFragment;
...
import org.fsr.collect.android.listeners.DownloadFormsTaskListener;
import org.fsr.collect.android.listeners.FormListDownloaderListener;
import org.fsr.collect.android.openrosa.HttpCredentialsInterface;
import org.fsr.collect.android.projects.ProjectsDataService;
import org.fsr.collect.android.tasks.DownloadFormListTask;
import org.fsr.collect.android.tasks.DownloadFormsTask;
import org.fsr.collect.android.utilities.ApplicationConstants;
import org.fsr.collect.android.utilities.AuthDialogUtility;
import org.fsr.collect.android.utilities.DialogUtils;
import org.fsr.collect.android.utilities.WebCredentialsUtils;
import org.fsr.collect.android.views.DayNightProgressDialog;
...
public class FormDownloadListActivity extends FormListActivity implements FormListDownloaderListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(org.fsr.collect.strings.R.string.get_forms));
    ...
    private void downloadFormList() {
        if (!connectivityProvider.isDeviceOnline()) {
            ...
            if (viewModel.isDownloadOnlyMode()) {
                setReturnResult(false, getString(org.fsr.collect.strings.R.string.no_connection), viewModel.getFormResults());
                finish();
            }
        } else {
    ...
    private void startFormsDownload(@NonNull ArrayList<ServerFormDetails> filesToDownload) {
        ...
        if (totalCount > 0) {
            ...
            ToastUtils.showShortToast(this, org.fsr.collect.strings.R.string.noselect_error);
        }
    }
        ...
        if (exception == null) {
            ...
            for (int i = 0; i < formList.size(); i++) {
                ...
                item.put(FORMID_DISPLAY,
                        ((details.getFormVersion() == null) ? "" : (getString(org.fsr.collect.strings.R.string.version) + " "
            ...
            if (exception instanceof FormSourceException.AuthRequired) {
                ...
                String dialogTitle = getString(org.fsr.collect.strings.R.string.load_remote_form_error);
    ...
    private void createAlertDialog(String title, String message, final boolean shouldExit) {
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, getString(org.fsr.collect.strings.R.string.ok), quitListener);
    ...
    private void createCancelDialog() {
        ...
        cancelDialog.setTitle(getString(org.fsr.collect.strings.R.string.canceling));
        cancelDialog.setMessage(getString(org.fsr.collect.strings.R.string.please_wait));
    ...
    public void progressUpdate(String currentFile, int progress, int total) {
        ...
        if (fragment != null) {
            fragment.setMessage(getString(org.fsr.collect.strings.R.string.fetching_file, currentFile,
