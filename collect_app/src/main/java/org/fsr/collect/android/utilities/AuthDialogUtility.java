...
public class AuthDialogUtility {
    ...
    public AlertDialog createDialog(final Context context,
        ...
        builder.setTitle(context.getString(org.fsr.collect.strings.R.string.server_requires_auth));
        builder.setMessage(context.getString(org.fsr.collect.strings.R.string.server_auth_credentials, overriddenUrl != null ? overriddenUrl : webCredentialsUtils.getServerUrlFromPreferences()));
        builder.setView(dialogView);
        String finalOverriddenUrl = overriddenUrl;
        builder.setPositiveButton(context.getString(org.fsr.collect.strings.R.string.ok), new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(context.getString(org.fsr.collect.strings.R.string.cancel),
