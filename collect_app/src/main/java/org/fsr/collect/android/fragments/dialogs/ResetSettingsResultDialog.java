...
public class ResetSettingsResultDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new MaterialAlertDialogBuilder(getActivity())
                .setTitle(org.fsr.collect.strings.R.string.reset_app_state_result)
                .setMessage(message)
                .setPositiveButton(org.fsr.collect.strings.R.string.ok, new DialogInterface.OnClickListener() {
                    @Override
