...
package org.fsr.collect.android.preferences;
...
public class ServerPreferencesAdder {
    ...
    public boolean add() {
        try {
            ...
            Toast.makeText(fragment.getActivity(), org.fsr.collect.strings.R.string.corrupt_imported_preferences_error, Toast.LENGTH_LONG).show();
            return false;
        }
    }
}
