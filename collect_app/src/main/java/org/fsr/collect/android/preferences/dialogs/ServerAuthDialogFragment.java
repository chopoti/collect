...
import org.fsr.collect.android.databinding.ServerAuthDialogBinding;
...
public class ServerAuthDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        return new MaterialAlertDialogBuilder(requireContext())
                .setTitle(org.fsr.collect.strings.R.string.server_requires_auth)
                .setMessage(requireContext().getString(org.fsr.collect.strings.R.string.server_auth_credentials, generalSettings.getString(ProjectKeys.KEY_SERVER_URL)))
                .setView(dialogView)
                .setPositiveButton(org.fsr.collect.strings.R.string.ok, (dialogInterface, i) -> {
