...
public class RangePickerDecimalWidget extends QuestionWidget {
    ...
    public IAnswerData getAnswer() {
        return binding.widgetAnswerText.getText().toString().equals(getContext().getString(org.fsr.collect.strings.R.string.no_value_selected))
                ? null
    ...
    private void setUpNullValue() {
        progress = 0;
        binding.widgetAnswerText.setText(getContext().getString(org.fsr.collect.strings.R.string.no_value_selected));
        binding.widgetButton.setText(getContext().getString(org.fsr.collect.strings.R.string.select_value));
    }
