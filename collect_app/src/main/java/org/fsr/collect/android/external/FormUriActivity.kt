...
import org.fsr.collect.android.savepoints.SavepointUseCases
...
private sealed class FormInspectionResult {
    ...
    data class Savepoint(val savepoint: org.fsr.collect.forms.savepoints.Savepoint) : FormInspectionResult()
