...
import org.fsr.collect.android.preferences.ServerPreferencesAdder;
import org.fsr.collect.android.preferences.filters.ControlCharacterFilter;
            ...
            switch (preference.getKey()) {
                ...
                case ProjectKeys.KEY_USERNAME:
                    ...
                    if (!username.equals(username.trim())) {
                        ToastUtils.showShortToast(requireContext(), org.fsr.collect.strings.R.string.username_error_whitespace);
                        return false;
                    }
                ...
                case ProjectKeys.KEY_PASSWORD:
                    ...
                    if (!pw.equals(pw.trim())) {
                        ToastUtils.showShortToast(requireContext(), org.fsr.collect.strings.R.string.password_error_whitespace);
                        return false;
                    }
