...
import static org.fsr.collect.metadata.PropertyManager.PROPMGR_DEVICE_ID;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_METADATA_EMAIL;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_METADATA_PHONENUMBER;
    ...
    private void setupPrefs() {
        emailPreference.setOnPreferenceChangeListener((preference, newValue) -> {
            ...
            if (!newValueString.isEmpty() && !Validator.isEmailAddressValid(newValueString)) {
                ToastUtils.showLongToast(requireContext(), org.fsr.collect.strings.R.string.invalid_email_address);
                return false;
            }
    ...
    private class PropertyManagerPropertySummaryProvider implements Preference.SummaryProvider<EditTextPreference> {
        ...
        public CharSequence provideSummary(EditTextPreference preference) {
            ...
            if (!TextUtils.isEmpty(value)) {
                ...
                return getString(org.fsr.collect.strings.R.string.preference_not_available);
            }
        }
    }
}
