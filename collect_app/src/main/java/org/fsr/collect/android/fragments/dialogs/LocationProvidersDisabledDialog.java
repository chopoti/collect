...
public class LocationProvidersDisabledDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        return new MaterialAlertDialogBuilder(getActivity())
                .setIcon(org.fsr.collect.permissions.R.drawable.ic_room_24dp)
                .setTitle(org.fsr.collect.strings.R.string.provider_disabled_error)
                .setMessage(org.fsr.collect.strings.R.string.location_providers_disabled_dialog_message)
                .setPositiveButton(org.fsr.collect.strings.R.string.go_to_settings, (dialog, id) -> {
