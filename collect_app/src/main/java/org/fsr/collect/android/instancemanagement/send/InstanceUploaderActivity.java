...
import org.fsr.collect.android.fragments.dialogs.SimpleDialog;
import org.fsr.collect.android.injection.DaggerUtils;
import org.fsr.collect.android.listeners.InstanceUploaderListener;
import org.fsr.collect.android.openrosa.OpenRosaConstants;
import org.fsr.collect.android.tasks.InstanceUploaderTask;
import org.fsr.collect.android.utilities.ApplicationConstants;
import org.fsr.collect.android.utilities.ArrayUtils;
...
import org.fsr.collect.android.utilities.InstanceUploaderUtils;
...
public class InstanceUploaderActivity extends LocalizedActivity implements InstanceUploaderListener,
    ...
    private void init(Bundle savedInstanceState) {
        alertMsg = getString(org.fsr.collect.strings.R.string.please_wait);
    ...
    public void progressUpdate(int progress, int total) {
        alertMsg = getString(org.fsr.collect.strings.R.string.sending_items, String.valueOf(progress), String.valueOf(total));
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case PROGRESS_DIALOG:
                ...
                progressDialog.setTitle(getString(org.fsr.collect.strings.R.string.uploading_data));
                progressDialog.setMessage(alertMsg);
                progressDialog.setIndeterminate(true);
                progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
                progressDialog.setCancelable(false);
                progressDialog.setButton(getString(org.fsr.collect.strings.R.string.cancel), loadingButtonListener);
    ...
    private void createUploadInstancesResultDialog(String message) {
        String dialogTitle = getString(org.fsr.collect.strings.R.string.upload_results);
        String buttonTitle = getString(org.fsr.collect.strings.R.string.ok);
