package org.fsr.collect.android.formentry.backgroundlocation;
...
import org.fsr.collect.android.logic.actions.setgeopoint.CollectSetGeopointAction;

/**
 * Manages background location for the location audit logging and fsr:setgeopoint action features.
 ...
 *
 * {@link CollectSetGeopointAction} fetches location for fsr:setgeopoint actions.
 *
...
public class BackgroundLocationManager implements LocationClient.LocationClientListener, LocationListener {
    ...
    public enum BackgroundLocationMessage {
        LOCATION_PREF_DISABLED(org.fsr.collect.strings.R.string.background_location_disabled, true),
        PLAY_SERVICES_UNAVAILABLE(org.fsr.collect.strings.R.string.google_play_services_not_available, false),
        COLLECTING_LOCATION(org.fsr.collect.strings.R.string.background_location_enabled, true),
