...
import org.fsr.collect.android.adapters.InstanceListCursorAdapter;
...
import org.fsr.collect.android.formmanagement.drafts.BulkFinalizationViewModel;
import org.fsr.collect.android.formmanagement.drafts.DraftsMenuProvider;
import org.fsr.collect.android.injection.DaggerUtils;
import org.fsr.collect.android.instancemanagement.FinalizeAllSnackbarPresenter;
...
import org.fsr.collect.strings.R.string;
...
public class InstanceChooserList extends AppListActivity implements AdapterView.OnItemClickListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (formMode == null || ApplicationConstants.FormModes.EDIT_SAVED.equalsIgnoreCase(formMode)) {
            setTitle(getString(org.fsr.collect.strings.R.string.review_data));
            editMode = true;
            ...
            setTitle(getString(org.fsr.collect.strings.R.string.view_sent_forms));
            EmptyListView emptyListView = findViewById(android.R.id.empty);
            emptyListView.setIcon(R.drawable.ic_baseline_inbox_72);
            emptyListView.setTitle(getString(org.fsr.collect.strings.R.string.empty_list_of_sent_forms_title));
            emptyListView.setSubtitle(getString(org.fsr.collect.strings.R.string.empty_list_of_sent_forms_subtitle));
        }
