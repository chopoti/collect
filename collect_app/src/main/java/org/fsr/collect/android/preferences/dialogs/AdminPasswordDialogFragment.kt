...
import org.fsr.collect.android.databinding.AdminPasswordDialogLayoutBinding
...
class AdminPasswordDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            ...
            .setTitle(getString(org.fsr.collect.strings.R.string.enter_admin_password))
            .setPositiveButton(getString(org.fsr.collect.strings.R.string.ok)) { _: DialogInterface?, _: Int ->
                if (adminPasswordProvider.adminPassword == binding.editText.text.toString()) {
                    ...
                    ToastUtils.showShortToast(
                        requireContext(),
                        org.fsr.collect.strings.R.string.admin_password_incorrect
                    )
                }
                dismiss()
            }
