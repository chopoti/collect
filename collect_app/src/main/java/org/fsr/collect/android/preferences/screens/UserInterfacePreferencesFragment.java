...
import static org.fsr.collect.android.activities.ActivityUtils.startActivityAndCloseAllOthers;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_APP_LANGUAGE;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_APP_THEME;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_FONT_SIZE;
    ...
    private void initLanguagePrefs() {
        ...
        if (pref != null) {
            ...
            entries.add(0, getActivity().getResources()
                    .getString(org.fsr.collect.strings.R.string.use_device_language));
