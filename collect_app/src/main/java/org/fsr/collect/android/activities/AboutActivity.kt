...
import org.fsr.collect.android.adapters.AboutItemClickListener
import org.fsr.collect.android.adapters.AboutListAdapter
...
class AboutActivity : LocalizedActivity(), AboutItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        websiteUri = Uri.parse(getString(org.fsr.collect.strings.R.string.app_url))
        forumUri = Uri.parse(getString(org.fsr.collect.strings.R.string.forum_url))
    }

    private fun initToolbar() {
        val toolbar = findViewById<Toolbar>(org.fsr.collect.androidshared.R.id.toolbar)
        title = getString(org.fsr.collect.strings.R.string.about_preferences)
    ...
    private fun shareApp() {
        val shareIntent = Intent(Intent.ACTION_SEND).apply {
            ...
            putExtra(
                Intent.EXTRA_TEXT,
                getString(org.fsr.collect.strings.R.string.tell_your_friends_msg) + " " + GOOGLE_PLAY_URL + packageName
            )
        }
        startActivity(
            Intent.createChooser(
                shareIntent,
                getString(org.fsr.collect.strings.R.string.tell_your_friends)
            )
        )
    }
    ...
    companion object {
        ...
        private val ITEMS = arrayOf(
            intArrayOf(
                ...
                org.fsr.collect.strings.R.string.odk_website,
                org.fsr.collect.strings.R.string.odk_website_summary
            ),
            intArrayOf(
                R.drawable.ic_outline_forum_24,
                org.fsr.collect.strings.R.string.odk_forum,
                org.fsr.collect.strings.R.string.odk_forum_summary
            ),
            intArrayOf(
                R.drawable.ic_outline_share_24,
                org.fsr.collect.strings.R.string.tell_your_friends,
                org.fsr.collect.strings.R.string.tell_your_friends_msg
            ),
            intArrayOf(
                R.drawable.ic_outline_rate_review_24,
                org.fsr.collect.strings.R.string.leave_a_review,
                org.fsr.collect.strings.R.string.leave_a_review_msg
            ),
            intArrayOf(
                R.drawable.ic_outline_stars_24,
                org.fsr.collect.strings.R.string.all_open_source_licenses,
                org.fsr.collect.strings.R.string.all_open_source_licenses_msg
            )
        )
    }
}
