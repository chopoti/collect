...
import static org.fsr.collect.android.analytics.AnalyticsEvents.SUBMISSION;
...
import org.fsr.collect.android.upload.FormUploadAuthRequestedException;
        ...
        for (int i = 0; i < instancesToUpload.size(); i++) {
            ...
            try {
                ...
                outcome.messagesByInstanceId.put(instance.getDbId().toString(),
                        customMessage != null ? customMessage : getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.success));
