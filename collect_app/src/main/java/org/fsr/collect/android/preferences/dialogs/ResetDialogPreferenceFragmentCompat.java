...
import static org.fsr.collect.android.fragments.dialogs.ResetSettingsResultDialog.RESET_SETTINGS_RESULT_DIALOG_TAG;
import static org.fsr.collect.android.projects.ProjectResetter.ResetAction.RESET_PREFERENCES;
...
import org.fsr.collect.android.fragments.dialogs.ResetSettingsResultDialog;
            ...
            switch (action) {
                case RESET_PREFERENCES:
                    if (failedResetActions.contains(action)) {
                        resultMessage.append(String.format(context.getString(org.fsr.collect.strings.R.string.reset_settings_result),
                                context.getString(org.fsr.collect.strings.R.string.error_occured)));
                    } else {
                        resultMessage.append(String.format(context.getString(org.fsr.collect.strings.R.string.reset_settings_result),
                                context.getString(org.fsr.collect.strings.R.string.success)));
                    }
                    break;
                case ProjectResetter.ResetAction.RESET_INSTANCES:
                    if (failedResetActions.contains(action)) {
                        resultMessage.append(String.format(context.getString(org.fsr.collect.strings.R.string.reset_saved_forms_result),
                                context.getString(org.fsr.collect.strings.R.string.error_occured)));
                    } else {
                        resultMessage.append(String.format(context.getString(org.fsr.collect.strings.R.string.reset_saved_forms_result),
                                context.getString(org.fsr.collect.strings.R.string.success)));
                ...
                case ProjectResetter.ResetAction.RESET_FORMS:
                    if (failedResetActions.contains(action)) {
                        resultMessage.append(String.format(context.getString(org.fsr.collect.strings.R.string.reset_blank_forms_result),
                                context.getString(org.fsr.collect.strings.R.string.error_occured)));
                    } else {
                        resultMessage.append(String.format(context.getString(org.fsr.collect.strings.R.string.reset_blank_forms_result),
                                context.getString(org.fsr.collect.strings.R.string.success)));
                ...
                case ProjectResetter.ResetAction.RESET_CACHE:
                    if (failedResetActions.contains(action)) {
                        resultMessage.append(String.format(context.getString(org.fsr.collect.strings.R.string.reset_cache_result),
                                context.getString(org.fsr.collect.strings.R.string.error_occured)));
                    } else {
                        resultMessage.append(String.format(context.getString(org.fsr.collect.strings.R.string.reset_cache_result),
                                context.getString(org.fsr.collect.strings.R.string.success)));
                ...
                case ProjectResetter.ResetAction.RESET_LAYERS:
                    if (failedResetActions.contains(action)) {
                        resultMessage.append(String.format(context.getString(org.fsr.collect.strings.R.string.reset_layers_result),
                                context.getString(org.fsr.collect.strings.R.string.error_occured)));
                    } else {
                        resultMessage.append(String.format(context.getString(org.fsr.collect.strings.R.string.reset_layers_result),
                                context.getString(org.fsr.collect.strings.R.string.success)));
