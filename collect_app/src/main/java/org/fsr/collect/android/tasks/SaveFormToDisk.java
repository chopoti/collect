...
import static org.fsr.collect.android.analytics.AnalyticsEvents.ENCRYPT_SUBMISSION;
...
import org.fsr.collect.android.exception.EncryptionException;
import org.fsr.collect.android.external.InstancesContract;
import org.fsr.collect.android.formentry.FormEntryUseCases;
import org.fsr.collect.android.formentry.saving.FormSaver;
...
import org.fsr.collect.android.utilities.EncryptionUtils;
import org.fsr.collect.android.utilities.EncryptionUtils.EncryptedFormInformation;
...
public class SaveFormToDisk {
    ...
    public SaveToDiskResult saveForm(FormSaver.ProgressListener progressListener) {
        ...
        progressListener.onProgressUpdate(getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.survey_saving_validating_message));
    ...
    private Instance exportData(boolean markCompleted, FormSaver.ProgressListener progressListener, ValidationResult validationResult) throws IOException, EncryptionException {
        progressListener.onProgressUpdate(getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.survey_saving_collecting_message));
        ...
        progressListener.onProgressUpdate(getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.survey_saving_saving_message));
        ...
        if (markCompleted) {
            ...
            progressListener.onProgressUpdate(
                    getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.survey_saving_finalizing_message));
            ...
            if (formInfo != null) {
                ...
                progressListener.onProgressUpdate(
                        getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.survey_saving_encrypting_message));
