...
import org.fsr.collect.android.databinding.TimeWidgetAnswerBinding;
...
public class TimeWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    public void clearAnswer() {
        selectedTime = DateTimeUtils.getCurrentDateTime();
        binding.timeAnswerText.setText(org.fsr.collect.strings.R.string.no_time_selected);
        widgetValueChanged();
    }

    @Override
    public IAnswerData getAnswer() {
        return binding.timeAnswerText.getText().equals(getContext().getString(org.fsr.collect.strings.R.string.no_time_selected))
                ? null
