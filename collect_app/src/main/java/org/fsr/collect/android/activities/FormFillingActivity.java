...
import static org.fsr.collect.android.formentry.FormIndexAnimationHandler.Direction.BACKWARDS;
import static org.fsr.collect.android.formentry.FormIndexAnimationHandler.Direction.FORWARDS;
import static org.fsr.collect.android.utilities.AnimationUtils.areAnimationsEnabled;
import static org.fsr.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.fsr.collect.android.utilities.DialogUtils.getDialog;
import static org.fsr.collect.androidshared.ui.DialogFragmentUtils.showIfNotShowing;
import static org.fsr.collect.androidshared.ui.ToastUtils.showLongToast;
import static org.fsr.collect.androidshared.ui.ToastUtils.showShortToast;
import static org.fsr.collect.settings.keys.ProjectKeys.KEY_NAVIGATION;
import static org.fsr.collect.settings.keys.ProtectedProjectKeys.KEY_MOVING_BACKWARDS;
...
import org.fsr.collect.android.audio.AMRAppender;
import org.fsr.collect.android.audio.AudioControllerView;
import org.fsr.collect.android.audio.AudioRecordingControllerFragment;
import org.fsr.collect.android.audio.M4AAppender;
import org.fsr.collect.android.dao.helpers.InstancesDaoHelper;
import org.fsr.collect.android.entities.EntitiesRepositoryProvider;
import org.fsr.collect.android.exception.JavaRosaException;
...
import org.fsr.collect.android.formentry.FormAnimation;
import org.fsr.collect.android.formentry.FormAnimationType;
import org.fsr.collect.android.formentry.FormEndView;
...
import org.fsr.collect.android.formentry.FormError;
import org.fsr.collect.android.formentry.FormIndexAnimationHandler;
import org.fsr.collect.android.formentry.FormIndexAnimationHandler.Direction;
import org.fsr.collect.android.formentry.FormLoadingDialogFragment;
...
import org.fsr.collect.android.formentry.QuitFormDialog;
import org.fsr.collect.android.formentry.RecordingHandler;
import org.fsr.collect.android.formentry.RecordingWarningDialogFragment;
import org.fsr.collect.android.formentry.SwipeHandler;
import org.fsr.collect.android.formentry.audit.AuditEvent;
import org.fsr.collect.android.formentry.audit.ChangesReasonPromptDialogFragment;
import org.fsr.collect.android.formentry.audit.IdentifyUserPromptDialogFragment;
...
import org.fsr.collect.android.formentry.loading.FormInstanceFileCreator;
import org.fsr.collect.android.formentry.media.AudioHelperFactory;
import org.fsr.collect.android.formentry.repeats.AddRepeatDialog;
...
import org.fsr.collect.android.formentry.saving.SaveAnswerFileProgressDialogFragment;
...
import org.fsr.collect.android.formhierarchy.ViewOnlyFormHierarchyActivity;
import org.fsr.collect.android.fragments.MediaLoadingFragment;
import org.fsr.collect.android.widgets.datetime.pickers.CustomDatePickerDialog;
import org.fsr.collect.android.widgets.datetime.pickers.CustomTimePickerDialog;
import org.fsr.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.fsr.collect.android.fragments.dialogs.NumberPickerDialog;
import org.fsr.collect.android.fragments.dialogs.RankingWidgetDialog;
...
import org.fsr.collect.android.javarosawrapper.RepeatsInFieldListException;
import org.fsr.collect.android.javarosawrapper.SuccessValidationResult;
import org.fsr.collect.android.javarosawrapper.ValidationResult;
import org.fsr.collect.android.listeners.AdvanceToNextListener;
import org.fsr.collect.android.listeners.FormLoaderListener;
import org.fsr.collect.android.listeners.WidgetValueChangedListener;
import org.fsr.collect.android.logic.ImmutableDisplayableQuestion;
import org.fsr.collect.android.mainmenu.MainMenuActivity;
import org.fsr.collect.android.projects.ProjectsDataService;
import org.fsr.collect.android.savepoints.SavepointListener;
import org.fsr.collect.android.savepoints.SavepointTask;
import org.fsr.collect.android.storage.StoragePathProvider;
import org.fsr.collect.android.storage.StorageSubdirectory;
import org.fsr.collect.android.tasks.FormLoaderTask;
import org.fsr.collect.android.tasks.SaveFormIndexTask;
import org.fsr.collect.android.utilities.ApplicationConstants;
import org.fsr.collect.android.utilities.ContentUriHelper;
import org.fsr.collect.android.utilities.ControllableLifecyleOwner;
...
import org.fsr.collect.android.widgets.datetime.DateTimeWidget;
import org.fsr.collect.android.widgets.QuestionWidget;
import org.fsr.collect.android.widgets.interfaces.WidgetDataReceiver;
import org.fsr.collect.android.widgets.items.SelectOneFromMapDialogFragment;
import org.fsr.collect.android.widgets.range.RangePickerDecimalWidget;
import org.fsr.collect.android.widgets.range.RangePickerIntegerWidget;
import org.fsr.collect.android.widgets.utilities.ExternalAppRecordingRequester;
import org.fsr.collect.android.widgets.utilities.FormControllerWaitingForDataRegistry;
import org.fsr.collect.android.widgets.utilities.InternalRecordingRequester;
import org.fsr.collect.android.widgets.utilities.ViewModelAudioPlayer;
import org.fsr.collect.android.widgets.utilities.WaitingForDataRegistry;
import org.fsr.collect.androidshared.system.IntentLauncher;
import org.fsr.collect.androidshared.system.PlayServicesChecker;
import org.fsr.collect.androidshared.system.ProcessRestoreDetector;
...
import org.fsr.collect.audioclips.AudioClipViewModel;
...
import org.fsr.collect.qrcode.QRCodeCreatorImpl;
 ...
 *
 * This class should never be started directly. Instead {@link org.fsr.collect.android.external.FormUriActivity}
...
public class FormFillingActivity extends LocalizedActivity implements AnimationListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        appBarLayout = findViewById(org.fsr.collect.androidshared.R.id.appBarLayout);
        ...
        MaterialProgressDialogFragment.showOn(this, printerWidgetViewModel.isLoading(), getSupportFragmentManager(), () -> {
            ...
            dialog.setMessage(getLocalizedString(this, org.fsr.collect.strings.R.string.loading));
            return dialog;
        });
    }
            ...
            if (session != null && session.getFile() != null) {
                recordingHandler.handle(getFormController(), session, file -> {
                    if (file != null) {
                        ...
                        String message = getString(org.fsr.collect.strings.R.string.answer_file_copy_failed_message, path);
    ...
    private void handleValidationResult(ValidationResult validationResult) {
        if (validationResult instanceof FailedValidationResult failedValidationResult) {
            ...
            SnackbarUtils.showLongSnackbar(findViewById(R.id.llParent), getString(org.fsr.collect.strings.R.string.success_form_validation), findViewById(R.id.buttonholder));
        }
    }
    ...
    private void initToolbar() {
        Toolbar toolbar = findViewById(org.fsr.collect.androidshared.R.id.toolbar);
        setSupportActionBar(toolbar);
        setTitle(getString(org.fsr.collect.strings.R.string.loading_form));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent intent) {
        ...
        if (intent == null && requestCode != RequestCodes.DRAW_IMAGE && requestCode != RequestCodes.ANNOTATE_IMAGE
            ...
            showLongToast(this, getString(org.fsr.collect.strings.R.string.null_intent_value));
            return;
        }
    ...
    private void loadMedia(Uri uri) {
        permissionsProvider.requestReadUriPermission(this, uri, getContentResolver(), () -> {
            ...
            progressDialog.setMessage(getString(org.fsr.collect.strings.R.string.please_wait));
                ...
                if (widget instanceof WidgetDataReceiver) {
                    if (waitingForDataRegistry.isWaitingForData(widget.getFormEntryPrompt().getIndex())) {
                        try {
                            ...
                            Timber.e(e);
                            ToastUtils.showLongToast(this, currentViewIfODKView.getContext().getString(org.fsr.collect.strings.R.string.error_attaching_binary_file,
                                    e.getMessage()));
                        }
                        set = true;
                        break;
    ...
    public void onCreateContextMenu(ContextMenu menu, View v,
        ...
        if (!swipeHandler.beenSwiped()) {
            ...
            menu.add(0, v.getId(), 0, getString(org.fsr.collect.strings.R.string.clear_answer));
            if (formController.indexContainsRepeatableGroup()) {
                menu.add(0, DELETE_REPEAT, 0, getString(org.fsr.collect.strings.R.string.delete_repeat));
            }
            menu.setHeaderTitle(getString(org.fsr.collect.strings.R.string.edit_prompt));
        }
    }
    ...
    private SwipeHandler.View createView(int event, boolean advancingPage) {
        ...
        switch (event) {
            ...
            default:
                ...
                try {
                    event = formController.stepToNextScreenEvent();
                    createErrorDialog(new FormError.Fatal(getString(org.fsr.collect.strings.R.string.survey_internal_error)));
                } catch (JavaRosaException e) {
                    Timber.d(e);
    ...
    private void createErrorDialog(FormError error) {
        ...
        if (formError instanceof FormError.Fatal) {
            alertDialog.setTitle(getString(org.fsr.collect.strings.R.string.form_cannot_be_used));
        } else {
            alertDialog.setTitle(getString(org.fsr.collect.strings.R.string.error_occured));
        }
        ...
        alertDialog.setButton(BUTTON_POSITIVE, getString(org.fsr.collect.strings.R.string.ok), errorListener);
        swipeHandler.setBeenSwiped(false);
        alertDialog.show();
    }
    ...
    public boolean saveForm(boolean exit, boolean complete, String updatedSaveName,
        ...
        if (current) {
            if (!formEntryViewModel.updateAnswersForScreen(getAnswers(), complete)) {
                showShortToast(this, org.fsr.collect.strings.R.string.data_saved_error);
                return false;
            }
        }
        ...
        switch (result.getState()) {
            ...
            case SAVED:
                ...
                if (result.getRequest().viewExiting()) {
                    ...
                    showShortToast(this, org.fsr.collect.strings.R.string.data_saved_ok);
                }
            ...
            case SAVE_ERROR:
                ...
                if (result.getMessage() != null) {
                    message = getString(org.fsr.collect.strings.R.string.data_saved_error) + " "
                            + result.getMessage();
                } else {
                    message = getString(org.fsr.collect.strings.R.string.data_saved_error);
                }
            ...
            case FINALIZE_ERROR:
                ...
                showLongToast(this, String.format(getString(org.fsr.collect.strings.R.string.encryption_error_message),
                        result.getMessage()));
                finishAndReturnInstance();
                formSaveViewModel.resumeFormEntry();
                break;
    ...
    private void createClearDialog(final QuestionWidget qw) {
        alertDialog = new MaterialAlertDialogBuilder(this).create();
        alertDialog.setTitle(getString(org.fsr.collect.strings.R.string.clear_answer_ask));
        ...
        alertDialog.setMessage(getString(org.fsr.collect.strings.R.string.clearanswer_confirm,
                question));
        ...
        alertDialog.setCancelable(false);
        alertDialog
                .setButton(BUTTON_POSITIVE, getString(org.fsr.collect.strings.R.string.discard_answer), quitListener);
        alertDialog.setButton(BUTTON_NEGATIVE, getString(org.fsr.collect.strings.R.string.clear_answer_no),
                quitListener);
        alertDialog.show();
    }
    ...
    public void createLanguageDialog() {
        ...
        alertDialog = new MaterialAlertDialogBuilder(this)
                ...
                .setTitle(getString(org.fsr.collect.strings.R.string.change_language))
                .setNegativeButton(getString(org.fsr.collect.strings.R.string.do_not_change), null).create();
        alertDialog.show();
    }
    ...
    public void loadingComplete(FormLoaderTask task, FormDef formDef, String warningMsg) {
        ...
        if (formController != null) {
            ...
            if (hasUsedSavepoint) {
                runOnUiThread(() -> showLongToast(this, org.fsr.collect.strings.R.string.savepoint_used));
            }
            ...
            if (formController.getInstanceFile() == null) {
                ...
                if (instanceFile != null) {
                    ...
                    showFormLoadErrorAndExit(getString(org.fsr.collect.strings.R.string.loading_form_failed));
                }
            ...
            showLongToast(this, org.fsr.collect.strings.R.string.loading_form_failed);
            exit();
        }
    }
    ...
    private void showFormLoadErrorAndExit(String errorMsg) {
        ...
        if (errorMsg != null) {
            ...
            createErrorDialog(new FormError.Fatal(getString(org.fsr.collect.strings.R.string.parse_error)));
        }
    }
    ...
    public void onProgressStep(String stepMessage) {
        ...
        if (dialog != null) {
            dialog.setMessage(getString(org.fsr.collect.strings.R.string.please_wait) + "\n\n" + stepMessage);
        }
    }
    ...
    public void onSavePointError(String errorMessage) {
        if (errorMessage != null && errorMessage.trim().length() > 0) {
            showLongToast(this, getString(org.fsr.collect.strings.R.string.save_point_error, errorMessage));
        }
    }
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Timber.e(e);
                        createErrorDialog(new FormError.Fatal(getString(org.fsr.collect.strings.R.string.update_widgets_error)));
                    }
                }
            });
        }
