...
import org.fsr.collect.android.widgets.interfaces.MultiChoiceWidget;
import org.fsr.collect.android.widgets.interfaces.SelectChoiceLoader;
import org.fsr.collect.android.widgets.warnings.SpacesInUnderlyingValuesWarning;
                    ...
                    try {
                        ...
                        if (imageFile.exists()) {
                            ...
                            if (b != null) {
                                ...
                                // likely
                                // a bad file.
                                errorMsg = getContext().getString(org.fsr.collect.strings.R.string.file_invalid, imageFile);
                            ...
                            // doesn't
                            // exist.
                            errorMsg = getContext().getString(org.fsr.collect.strings.R.string.file_missing, imageFile);
                        }
