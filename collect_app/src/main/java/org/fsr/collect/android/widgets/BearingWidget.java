...
import org.fsr.collect.android.databinding.BearingWidgetAnswerBinding;
import org.fsr.collect.android.formentry.questions.QuestionDetails;
import org.fsr.collect.android.widgets.utilities.StringWidgetUtils;
...
public class BearingWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    protected View onCreateAnswerView(Context context, FormEntryPrompt prompt, int answerFontSize) {
        ...
        if (answerText != null && !answerText.isEmpty()) {
            binding.bearingButton.setText(getContext().getString(org.fsr.collect.strings.R.string.replace_bearing));
        }
    ...
    public void clearAnswer() {
        binding.bearingButton.setText(getContext().getString(org.fsr.collect.strings.R.string.get_bearing));
    ...
    private void onButtonClick() {
        if (areSensorsAvailable()) {
            ...
            ToastUtils.showLongToast(getContext(), org.fsr.collect.strings.R.string.bearing_lack_of_sensors);
