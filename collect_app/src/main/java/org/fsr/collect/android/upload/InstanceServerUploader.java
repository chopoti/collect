...
package org.fsr.collect.android.upload;
...
import org.fsr.collect.android.utilities.ResponseMessageParser;
    ...
    public String uploadOneSubmission(Instance instance, String urlString) throws FormUploadException {
        ...
        if (uriRemap.containsKey(submissionUri)) {
            ...
            try {
                ...
                throw new FormUploadException(getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.url_error));
            }
            ...
            if (headResult.getStatusCode() == HttpsURLConnection.HTTP_UNAUTHORIZED) {
                throw new FormUploadAuthRequestedException(getLocalizedString(Collect.getInstance(), org.fsr.collect.strings.R.string.server_auth_credentials, submissionUri.getHost()),
                        submissionUri);
