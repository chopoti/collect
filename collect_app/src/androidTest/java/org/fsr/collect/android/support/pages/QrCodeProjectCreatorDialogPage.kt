...
class QrCodeProjectCreatorDialogPage : Page<QrCodeProjectCreatorDialogPage>() {
    ...
    fun switchToManualMode(): ManualProjectCreatorDialogPage {
        return clickOnTextInDialog(org.fsr.collect.strings.R.string.configure_manually, ManualProjectCreatorDialogPage())
    }

    fun assertDuplicateDialogShown(): QrCodeProjectCreatorDialogPage {
        onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.duplicate_project_details)))
            .inRoot(isDialog())
    ...
    fun switchToExistingProject(): MainMenuPage {
        return clickOnTextInDialog(org.fsr.collect.strings.R.string.switch_to_existing, MainMenuPage())
    }

    fun addDuplicateProject(): MainMenuPage {
        return clickOnTextInDialog(org.fsr.collect.strings.R.string.add_duplicate_project, MainMenuPage())
    }
}
