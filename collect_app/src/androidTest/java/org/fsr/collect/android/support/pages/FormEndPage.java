...
public class FormEndPage extends Page<FormEndPage> {
    ...
    public FormEndPage assertOnPage() {
        onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.save_enter_data_description, formName))).check(matches(isDisplayed()));
        return this;
    }

    public <D extends Page<D>> D clickSaveAsDraft(D destination) {
        return clickOnString(org.fsr.collect.strings.R.string.save_as_draft, destination);
    }
    ...
    public <D extends Page<D>> D clickFinalize(D destination) {
        return clickOnString(org.fsr.collect.strings.R.string.finalize, destination);
    }
    ...
    public MainMenuPage clickSend() {
        clickOnString(org.fsr.collect.strings.R.string.send);
