...
import static org.fsr.collect.android.instancemanagement.InstanceExtKt.getInstanceIcon;
...
public class EditSavedFormPage extends Page<EditSavedFormPage> {
    ...
    public EditSavedFormPage assertOnPage() {
        ...
        assertText(org.fsr.collect.strings.R.string.review_data);
        return this;
    }

    private void closeDraftsPillsEducationDialog() {
        if (firstOpen) {
            assertTextInDialog(org.fsr.collect.strings.R.string.new_feature);
            clickOKOnDialog();
        }
    }
    ...
    public BulkFinalizationConfirmationDialogPage clickFinalizeAll(int count) {
        this.clickOptionsIcon(org.fsr.collect.strings.R.string.finalize_all_drafts)
                .clickOnString(org.fsr.collect.strings.R.string.finalize_all_drafts);
