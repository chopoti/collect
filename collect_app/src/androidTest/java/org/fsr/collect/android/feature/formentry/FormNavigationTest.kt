...
class FormNavigationTest {
    ...
    fun showsAndHidesButtonsCorrectlyOnEachScreen() {
        rule.startAtMainMenu()
            ...
            .assertTextDoesNotExist(org.fsr.collect.strings.R.string.form_backward)
            .clickForwardButton()
            ...
            .assertText(org.fsr.collect.strings.R.string.form_backward)
            .assertTextDoesNotExist(org.fsr.collect.strings.R.string.form_forward)
    }
