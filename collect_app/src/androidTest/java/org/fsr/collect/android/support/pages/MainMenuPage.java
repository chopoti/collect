...
import org.fsr.collect.android.support.StorageUtils;
import org.fsr.collect.android.support.TestScheduler;
...
public class MainMenuPage extends Page<MainMenuPage> {
    ...
    public MainMenuPage assertOnPage() {
        return WaitFor.waitFor(() -> {
            onView(withText(org.fsr.collect.strings.R.string.enter_data)).check(matches(isDisplayed()));
            onView(withText(containsString(getTranslatedString(org.fsr.collect.strings.R.string.collect_app_name)))).perform(scrollTo()).check(matches(isDisplayed()));
            return this;
        });
    }
    ...
    public ProjectSettingsDialogPage openProjectSettingsDialog() {
        ...
        clickOnContentDescription(org.fsr.collect.strings.R.string.projects);
    ...
    public <D extends Page<D>> D clickGetBlankForm(D destination) {
        onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.get_forms))).perform(scrollTo(), click());
    ...
    public MainMenuPage enableManualUpdates() {
        return openProjectSettingsDialog()
                ...
                .clickFormManagement()
                .clickUpdateForms()
                .clickOption(org.fsr.collect.strings.R.string.manual)
                .pressBack(new ProjectSettingsPage())
                .pressBack(new MainMenuPage());
    }
    ...
    public MainMenuPage enablePreviouslyDownloadedOnlyUpdatesWithAutomaticDownload() {
        return openProjectSettingsDialog()
                ...
                .clickUpdateForms()
                .clickOption(org.fsr.collect.strings.R.string.previously_downloaded_only)
                .clickOnString(org.fsr.collect.strings.R.string.automatic_download)
                .pressBack(new ProjectSettingsPage())
                .pressBack(new MainMenuPage());
    }
    ...
    public ViewSentFormPage clickViewSentForm(int number) {
        ...
        onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.view_sent_forms))).perform(click());
        return new ViewSentFormPage().assertOnPage();
    }

    public DeleteSavedFormPage clickDeleteSavedForm() {
        onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.manage_files))).perform(scrollTo(), click());
    ...
    public EntitiesPage openEntityBrowser() {
        openProjectSettingsDialog()
                .clickSettings()
                .clickExperimental()
                .clickOnString(org.fsr.collect.strings.R.string.entity_browser_button);
    ...
    public MainMenuPage disableLocalEntitiesInForms() {
        return openProjectSettingsDialog()
                .clickSettings()
                .clickExperimental()
                .clickOnString(org.fsr.collect.strings.R.string.include_local_entities_setting)
                .pressBack(new ProjectSettingsPage())
                .pressBack(new MainMenuPage());
    }
}
