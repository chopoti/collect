package org.fsr.collect.android.feature.instancemanagement
...
class SendFinalizedFormTest {
    ...
    fun whenDeleteAfterSendIsEnabled_deletesFilledForm() {
        rule.withProject(testDependencies.server.url)
            ...
            .clickSettings()
            .clickFormManagement()
            .scrollToRecyclerViewItemAndClickText(org.fsr.collect.strings.R.string.delete_after_send)
    ...
    fun whenThereAreSentAndReadyToSendForms_displayTheBanner() {
        rule.withProject(testDependencies.server.url)
            ...
            .clickSendSelected()
            .clickOK(SendFinalizedFormPage())
            .assertQuantityText(org.fsr.collect.strings.R.plurals.forms_ready_to_send, 1, 1)
    }
