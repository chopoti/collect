...
import org.fsr.collect.android.support.pages.SaveOrDiscardFormDialog
import org.fsr.collect.android.support.pages.UserAndDeviceIdentitySettingsPage
...
class FormMetadataSettingsTest {
    ...
    fun metadataShouldBeDisplayedInPreferences() {
        rule.startAtMainMenu()
            ...
            .assertPreference(org.fsr.collect.strings.R.string.username, "Chino")
            .assertPreference(org.fsr.collect.strings.R.string.phone_number, "123")
            .assertPreference(org.fsr.collect.strings.R.string.email, "chino@whitepony.com")
            .assertPreference(org.fsr.collect.strings.R.string.device_id, installIDProvider.installID)
    }
    ...
    fun setEmail_validatesEmail() {
        rule.startAtMainMenu()
            ...
            .inputText("aabb")
            .clickOKOnDialog()
            .checkIsToastWithMessageDisplayed(org.fsr.collect.strings.R.string.invalid_email_address)
            .clickEmail()
            .inputText("aa@bb")
            .clickOKOnDialog()
            .assertText("aa@bb")
