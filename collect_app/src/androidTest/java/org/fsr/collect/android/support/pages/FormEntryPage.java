...
import static org.fsr.collect.android.support.matchers.CustomMatchers.isQuestionView;
import static org.fsr.collect.android.support.matchers.CustomMatchers.withIndex;
...
import org.fsr.collect.androidtest.DrawableMatcher;
...
public class FormEntryPage extends Page<FormEntryPage> {
    ...
    public FormEntryPage assertOnPage() {
        ...
        WaitFor.waitFor((Callable<Void>) () -> {
            assertTextDoesNotExist(org.fsr.collect.strings.R.string.loading_form);
            return null;
        });
    ...
    public FormEntryPage clickOptionsIcon() {
        return clickOptionsIcon(org.fsr.collect.strings.R.string.project_settings);
    }

    public ProjectSettingsPage clickGeneralSettings() {
        onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.project_settings))).perform(click());
    ...
    public FormEntryPage deleteGroup(String questionText) {
        ...
        clickOnTextInPopup(org.fsr.collect.strings.R.string.delete_repeat);
        clickOnTextInDialog(org.fsr.collect.strings.R.string.discard_group, this);
        return this;
    }

    public FormEntryPage clickForwardButton() {
        closeSoftKeyboard();
        onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.form_forward))).perform(click());
        return this;
    }
    ...
    public FormEntryPage clickBackwardButton() {
        closeSoftKeyboard();
        onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.form_backward))).perform(click());
        return this;
    }
    ...
    public FormEntryPage longPressOnQuestion(String question, boolean isRequired) {
        WaitFor.tryAgainOnFail(() -> {
            ...
            assertText(org.fsr.collect.strings.R.string.clear_answer);
        });
    ...
    public FormEntryPage removeResponse() {
        onView(withText(org.fsr.collect.strings.R.string.clear_answer)).perform(click());
        return clickOnTextInDialog(org.fsr.collect.strings.R.string.discard_answer, this);
    }
    ...
    public OkDialog swipeToEndScreenWhileRecording() {
        ...
        assertText(org.fsr.collect.strings.R.string.recording_warning);
        return okDialog;
    }

    public CancelRecordingDialog clickRecordAudio() {
        clickOnString(org.fsr.collect.strings.R.string.record_audio_on);
    ...
    public FormEntryPage assertBackgroundLocationSnackbarShown() {
        onView(withId(com.google.android.material.R.id.snackbar_text))
                .check(matches(withText(String.format(ApplicationProvider.getApplicationContext().getString(org.fsr.collect.strings.R.string.background_location_enabled), "⋮"))));
        return this;
    }
