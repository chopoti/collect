...
public class QRCodePage extends Page<QRCodePage> {
    ...
    public QRCodePage clickScanFragment() {
        onView(withText(org.fsr.collect.strings.R.string.scan_qr_code_fragment_title)).perform(click());
        return this;
    }
    ...
    public QRCodePage clickView() {
        ...
        WaitFor.waitFor(() -> {
            onView(withText(org.fsr.collect.strings.R.string.view_qr_code_fragment_title)).perform(click());
            onView(withText(org.fsr.collect.strings.R.string.barcode_scanner_prompt)).check(doesNotExist());
            return null;
        });
    ...
    public QRCodePage clickOnMenu() {
        return tryAgainOnFail(this, () -> {
            ...
            onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.import_qrcode_sd))).check(matches(isDisplayed()));
        });
    }
}
