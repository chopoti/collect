...
object StorageUtils {
    ...
    private fun copyFormMediaFiles(formFilename: String, mediaFilePaths: List<String>, projectName: String) {
        val mediaPathName = getFormsDirPath(projectName) + formFilename.replace(".xml", "") + org.fsr.collect.android.utilities.FileUtils.MEDIA_SUFFIX + "/"
        org.fsr.collect.android.utilities.FileUtils.checkMediaPath(File(mediaPathName))
