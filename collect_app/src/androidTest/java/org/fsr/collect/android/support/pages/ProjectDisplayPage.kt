...
class ProjectDisplayPage : Page<ProjectDisplayPage>() {
    override fun assertOnPage(): ProjectDisplayPage {
        assertText(org.fsr.collect.strings.R.string.project_display_title)
        return this
    }

    fun setProjectName(projectName: String): ProjectDisplayPage {
        clickOnString(org.fsr.collect.strings.R.string.project_name)
    ...
    fun setProjectIcon(projectIcon: String): ProjectDisplayPage {
        clickOnString(org.fsr.collect.strings.R.string.project_icon)
    ...
    fun setProjectColor(projectColor: String): ProjectDisplayPage {
        clickOnString(org.fsr.collect.strings.R.string.project_color)
        onView(withContentDescription(org.fsr.collect.strings.R.string.hex_color)).perform(replaceText(projectColor))
        clickOKOnDialog()
        return this
    }
}
