...
class MovingBackwardsTest {
    ...
    fun whenMovingBackwardDisabledWithPreventingUsersFormBypassingIt_relatedOptionsShouldBeUpdated() {
        rule.startAtMainMenu()
            ...
            .clickOnString(org.fsr.collect.strings.R.string.yes)
            ...
            .assertTextDoesNotExist(org.fsr.collect.strings.R.string.constraint_behavior_on_finalize)
            .assertText(org.fsr.collect.strings.R.string.constraint_behavior_on_swipe)
    }
    ...
    fun whenMovingBackwardDisabledWithoutPreventingUsersFormBypassingIt_relatedOptionsShouldNotBeUpdated() {
        rule.startAtMainMenu()
            ...
            .clickMovingBackwards()
            .clickOnString(org.fsr.collect.strings.R.string.no)
            ...
            .assertText(org.fsr.collect.strings.R.string.constraint_behavior_on_finalize)
            .assertTextDoesNotExist(org.fsr.collect.strings.R.string.constraint_behavior_on_swipe)
    }
    ...
    private fun MainMenuPage.disableFinalizeInFormEntry(): ProjectSettingsPage {
        return openProjectSettingsDialog()
            ...
            .clickOnString(org.fsr.collect.strings.R.string.finalize)
            .pressBack(AccessControlPage())
            .pressBack(ProjectSettingsPage())
    }
    ...
    private fun ProjectSettingsPage.setConstraintProcessingToOnFinalize(): ProjectSettingsPage {
        return openFormManagement()
            ...
            .clickOnString(org.fsr.collect.strings.R.string.constraint_behavior_on_finalize)
            .pressBack(ProjectSettingsPage())
    }
