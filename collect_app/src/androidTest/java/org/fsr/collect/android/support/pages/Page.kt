...
import org.fsr.collect.android.support.ActivityHelpers.getLaunchIntent
import org.fsr.collect.android.support.actions.RotateAction
import org.fsr.collect.android.support.matchers.CustomMatchers.withIndex
import org.fsr.collect.android.support.rules.RecentAppsRule
import org.fsr.collect.android.utilities.ActionRegister
import org.fsr.collect.androidshared.ui.ToastUtils.popRecordedToasts
...
import org.fsr.collect.testshared.Assertions
...
import org.fsr.collect.testshared.WaitFor.wait250ms
import org.fsr.collect.testshared.WaitFor.waitFor
...
abstract class Page<T : Page<T>> {
    ...
    protected fun assertToolbarTitle(title: String?) {
        onView(
            allOf(
                withText(title),
                isDescendantOfA(withId(org.fsr.collect.androidshared.R.id.toolbar))
            )
    ...
    fun closeSnackbar(): T {
        Interactions.clickOn(withContentDescription(org.fsr.collect.strings.R.string.close_snackbar))
        return this as T
    }
