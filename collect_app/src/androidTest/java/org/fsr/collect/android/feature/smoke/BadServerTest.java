...
import org.fsr.collect.android.support.TranslatedStringBuilder;
    ...
    public void whenHashNotIncludedInFormList_showError() {
        ...
        rule.withProject(testDependencies.server.getURL())
                ...
                .assertError(new TranslatedStringBuilder()
                        .addString(org.fsr.collect.strings.R.string.form_with_no_hash_error)
                        .addString(org.fsr.collect.strings.R.string.report_to_project_lead)
                        .build()
                )
                .navigateBack();
    }
    ...
    */
    public void whenMediaFileHasMissingPrefix_showsAsUpdated() {
        ...
        rule.withProject(testDependencies.server.getURL())
                ...
                .clickGetBlankForm()
                .assertText(org.fsr.collect.strings.R.string.newer_version_of_a_form_info);
    }
