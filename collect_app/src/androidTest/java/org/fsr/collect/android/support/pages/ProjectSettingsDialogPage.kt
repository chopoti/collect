...
internal class ProjectSettingsDialogPage : Page<ProjectSettingsDialogPage>() {
    ...
    override fun assertOnPage(): ProjectSettingsDialogPage {
        assertText(org.fsr.collect.strings.R.string.projects)
        return this
    }

    fun clickSettings(): ProjectSettingsPage {
        return clickOnTextInDialog(
            org.fsr.collect.strings.R.string.settings,
            ProjectSettingsPage()
        )
    }
    ...
    fun clickAbout(): AboutPage {
        return clickOnTextInDialog(
            org.fsr.collect.strings.R.string.about_preferences,
            AboutPage()
        )
    }
    ...
    fun clickAddProject(): QrCodeProjectCreatorDialogPage {
        return clickOnTextInDialog(
            org.fsr.collect.strings.R.string.add_project,
        ...
        onView(
            allOf(
                ...
                withContentDescription(
                    getTranslatedString(
                        org.fsr.collect.strings.R.string.using_project,
                        projectName
                    )
                )
            )
    ...
    fun assertInactiveProject(projectName: String, subtext: String): ProjectSettingsDialogPage {
        onView(
            allOf(
                ...
                withContentDescription(
                    getTranslatedString(
                        org.fsr.collect.strings.R.string.switch_to_project,
                        projectName
                    )
                )
            )
