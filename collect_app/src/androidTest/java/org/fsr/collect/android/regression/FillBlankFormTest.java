package org.fsr.collect.android.regression;
...
import static org.fsr.collect.androidtest.DrawableMatcher.withImageDrawable;
import static org.fsr.collect.testshared.RecyclerViewMatcher.withRecyclerView;
...
import org.fsr.collect.android.support.ActivityHelpers;
import org.fsr.collect.android.support.pages.FormEndPage;
...
public class FillBlankFormTest {
    ...
    public void searchExpression_ShouldDisplayWhenItContainsOtherAppearanceName() {
        ...
        rule.startAtMainMenu()
                ...
                .swipeToEndScreen()
                .clickFinalize()
                .checkIsSnackbarWithMessageDisplayed(org.fsr.collect.strings.R.string.form_saved);
    }
    ...
    public void answers_shouldBeAutoFilled() {
        //TestCase50
        rule.startAtMainMenu()
                .copyForm("event-fsr-new-repeat.xml")
                .startBlankForm("Event: fsr-new-repeat")
                .inputText("3")
                .swipeToNextQuestionWithRepeatGroup("null")
                .clickOnAdd(new FormEntryPage("Event: fsr-new-repeat"))
                .assertText("1")
                ...
                .assertText("5")
                .swipeToNextQuestionWithRepeatGroup("null")
                .clickOnDoNotAdd(new FormEntryPage("Event: fsr-new-repeat"))
                .inputText("2")
                ...
                .swipeToNextQuestion("C value")
                .swipeToNextQuestionWithRepeatGroup("null")
                .clickOnDoNotAdd(new FormEndPage("Event: fsr-new-repeat"))
                .clickFinalize();
    }
