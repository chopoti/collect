...
import org.fsr.collect.android.support.pages.ViewSentFormPage
...
class AutoSendTest {
    ...
    fun whenAutoSendEnabled_fillingAndFinalizingForm_sendsFormAndNotifiesUser() {
        ...
        notificationDrawerRule
            .open()
            .assertNotification("FSR Collect", "Forms upload succeeded", "All uploads succeeded!")
            .clickNotification(
                "FSR Collect",
    ...
    fun whenAutoSendEnabled_fillingAndFinalizingForm_notifiesUserWhenSendingFails() {
        ...
        notificationDrawerRule
            .open()
            .assertNotification("FSR Collect", "Forms upload failed", "1 of 1 uploads failed!")
            .clickAction(
                "FSR Collect",
                "Forms upload failed",
                "Show details",
