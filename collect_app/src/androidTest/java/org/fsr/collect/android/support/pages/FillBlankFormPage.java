...
import static org.fsr.collect.testshared.ViewActions.clickOnViewContentDescription;
...
public class FillBlankFormPage extends Page<FillBlankFormPage> {
    ...
    public FillBlankFormPage assertOnPage() {
        assertToolbarTitle(org.fsr.collect.strings.R.string.enter_data);
        return this;
    }
    ...
    public FillBlankFormPage checkMapIconDisplayedForForm(String formName) {
        onView(withId(R.id.form_list))
                ...
                .check(matches(hasDescendant(allOf(withContentDescription(org.fsr.collect.strings.R.string.open_form_map), withEffectiveVisibility(ViewMatchers.Visibility.VISIBLE)))));
        return this;
    }
    ...
    public FillBlankFormPage checkMapIconNotDisplayedForForm(String formName) {
        onView(withId(R.id.form_list))
                .perform(RecyclerViewActions.actionOnItem(hasDescendant(withText(formName)), scrollTo()))
                .check(matches(hasDescendant(allOf(withContentDescription(org.fsr.collect.strings.R.string.open_form_map), withEffectiveVisibility(ViewMatchers.Visibility.GONE)))));
        return this;
    }

    public FormMapPage clickOnMapIconForForm(String formName) {
        onView(withId(R.id.form_list))
                .perform(RecyclerViewActions.actionOnItem(hasDescendant(withText(formName)), clickOnViewContentDescription(org.fsr.collect.strings.R.string.open_form_map, ApplicationProvider.getApplicationContext())));
    ...
    public FillBlankFormPage assertFormExists(String formName) {
        ...
        return WaitFor.waitFor(() -> {
            assertTextDoesNotExist(org.fsr.collect.strings.R.string.empty_list_of_drafts_title);
    ...
    public FillBlankFormPage assertNoForms() {
        assertText(org.fsr.collect.strings.R.string.empty_list_of_blank_forms_title);
        return this;
    }
}
