...
public class DeleteSavedFormPage extends Page<DeleteSavedFormPage> {
    ...
    public DeleteSavedFormPage assertOnPage() {
        assertToolbarTitle(getTranslatedString(org.fsr.collect.strings.R.string.manage_files));
        return this;
    }

    public DeleteSavedFormPage clickBlankForms() {
        clickOnString(org.fsr.collect.strings.R.string.forms);
        return this;
    }
    ...
    public DeleteSelectedDialog clickDeleteSelected(int numberSelected) {
        clickOnString(org.fsr.collect.strings.R.string.delete_file);
