package org.fsr.collect.android.feature.maps
...
import org.fsr.collect.externalapp.ExternalAppUtils.getReturnIntent
...
class FormMapTest {
        ...
        rule.startAtMainMenu()
            ...
            .assertText(
                getApplicationContext<Context>().resources.getString(
                    ...
                    getApplicationContext<Context>().resources.getString(org.fsr.collect.strings.R.string.saved_forms),
                    1,
                    1
                )
            )
    ...
    private fun stubGeopointIntent() {
        ...
        intending(hasComponent("org.fsr.collect.geo.geopoint.GeoPointActivity"))
            .respondWith(result)
    }
