...
public class IdentifyUserPromptPage extends Page<IdentifyUserPromptPage> {
    ...
    public IdentifyUserPromptPage assertOnPage() {
        ...
        assertTextInDialog(org.fsr.collect.strings.R.string.enter_identity);
        return this;
    }

    public IdentifyUserPromptPage enterIdentity(String identity) {
        onView(withHint(getTranslatedString(org.fsr.collect.strings.R.string.identity))).perform(replaceText(identity));
        return this;
    }

    public <D extends Page<D>> D clickKeyboardEnter(D destination) {
        onView(withHint(getTranslatedString(org.fsr.collect.strings.R.string.identity))).perform(pressImeActionButton());
