...
class ErrorPage : Page<ErrorPage>() {
    ...
    override fun assertOnPage(): ErrorPage {
        assertText(org.fsr.collect.strings.R.string.errors)
        return this
    }
    ...
    fun navigateBack(): MainMenuPage {
        onView(allOf(instanceOf(AppCompatImageButton::class.java), withParent(withId(org.fsr.collect.androidshared.R.id.toolbar)))).perform(click())
        return MainMenuPage()
    }
}
