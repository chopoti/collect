...
public class AddNewRepeatDialog extends Page<AddNewRepeatDialog> {
    ...
    public AddNewRepeatDialog assertOnPage() {
        onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.add_repeat_question, repeatName)))
                .inRoot(isDialog())
    ...
    public <D extends Page<D>> D clickOnAdd(D destination) {
        return clickOnTextInDialog(org.fsr.collect.strings.R.string.add_repeat, destination);
    }

    public <D extends Page<D>> D clickOnDoNotAdd(D destination) {
        return clickOnTextInDialog(org.fsr.collect.strings.R.string.dont_add_repeat, destination);
    }
