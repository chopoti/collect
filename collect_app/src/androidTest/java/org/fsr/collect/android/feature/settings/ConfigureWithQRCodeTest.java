...
import org.fsr.collect.android.support.pages.QRCodePage;
...
public class ConfigureWithQRCodeTest {
    ...
    public void clickConfigureQRCode_opensScanner_andThenScanning_importsSettings() {
        ...
        qrCodePage
                .checkIsToastWithMessageDisplayed(org.fsr.collect.strings.R.string.successfully_imported_settings)
    ...
    public void whenThereIsAnAdminPassword_canRemoveFromQRCode() {
        rule.startAtMainMenu()
                ...
                .clickConfigureQR()
                .clickView()
                .clickOnString(org.fsr.collect.strings.R.string.qrcode_with_admin_password)
                .clickOnString(org.fsr.collect.strings.R.string.admin_password)
                .clickOnString(org.fsr.collect.strings.R.string.generate)
                .assertText(org.fsr.collect.strings.R.string.qrcode_without_passwords);
    }
    ...
    public void whenThereIsAServerPassword_canRemoveFromQRCode() {
        rule.startAtMainMenu()
                ...
                .clickConfigureQR()
                .clickView()
                .clickOnString(org.fsr.collect.strings.R.string.qrcode_with_server_password)
                .clickOnString(org.fsr.collect.strings.R.string.server_password)
                .clickOnString(org.fsr.collect.strings.R.string.generate)
                .assertText(org.fsr.collect.strings.R.string.qrcode_without_passwords);
    }
