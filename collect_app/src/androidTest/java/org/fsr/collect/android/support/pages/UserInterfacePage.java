...
public class UserInterfacePage extends Page<UserInterfacePage> {
    ...
    public UserInterfacePage assertOnPage() {
        assertText(org.fsr.collect.strings.R.string.client);
        return this;
    }

    public UserInterfacePage clickOnLanguage() {
        onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.language))).perform(click());
        return this;
    }
    ...
    public UserInterfacePage clickNavigation() {
        clickOnString(org.fsr.collect.strings.R.string.navigation);
        return this;
    }

    public UserInterfacePage clickUseSwipesAndButtons() {
        clickOnString(org.fsr.collect.strings.R.string.swipe_buttons_navigation);
        return this;
    }

    public UserInterfacePage clickOnTheme() {
        onView(withText(getTranslatedString(org.fsr.collect.strings.R.string.app_theme))).perform(click());
        return this;
    }

    public UserInterfacePage clickUseNavigationButtons() {
        clickOnString(org.fsr.collect.strings.R.string.buttons_navigation);
        return this;
    }

    public UserInterfacePage clickSwipes() {
        clickOnString(org.fsr.collect.strings.R.string.swipe_navigation);
        return this;
    }
}
