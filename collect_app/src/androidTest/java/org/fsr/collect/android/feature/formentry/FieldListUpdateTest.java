...
public class FieldListUpdateTest {
    ...
    public void clearingParentSelect_ShouldUpdateAllDependentLevels() {
        ...
        onView(withText(org.fsr.collect.strings.R.string.discard_answer)).perform(click());
    ...
    public void selectingADateForDateTime_ShouldChangeRelevanceOfRelatedField() {
        ...
        onView(withText(org.fsr.collect.strings.R.string.select_date)).perform(click());
    ...
    public void recordingAudio_ShouldChangeRelevanceOfRelatedField() {
        new FormEntryPage("fieldlist-updates")
                ...
                .assertText("Target16")
                .clickOnString(org.fsr.collect.strings.R.string.delete_answer_file)
                .clickOnTextInDialog(org.fsr.collect.strings.R.string.delete_answer_file, new FormEntryPage("fieldlist-updates"))
                .assertTextDoesNotExist("Target16");
    }
    ...
    public void changeInValueUsedToDetermineIfAQuestionIsRequired_ShouldUpdateTheRelatedRequiredQuestion() {
        new FormEntryPage("fieldlist-updates")
                ...
                .swipeToNextQuestionWithConstraintViolation(org.fsr.collect.strings.R.string.required_answer_error)
                .answerQuestion(0, "")
                .assertQuestion("Target17")
                .assertTextDoesNotExist(org.fsr.collect.strings.R.string.required_answer_error);
    }
