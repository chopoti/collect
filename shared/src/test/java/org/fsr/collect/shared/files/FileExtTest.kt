package org.fsr.collect.shared.files
...
import org.fsr.collect.shared.files.FileExt.listFilesRecursively
import org.fsr.collect.shared.files.FileExt.sanitizedCanonicalPath
import org.fsr.collect.shared.files.FileExt.saveToFile
import java.io.File
...
class FileExtTest {
    ...
    fun `sanitizedCanonicalPath returns sanitized canonicalPath if androidData path segment is incorrect`() {
        val file = mock<File>().apply {
            whenever(canonicalPath).thenReturn("/storage/emulated/0/android/Data/org.fsr.collect.android/files/projects/DEMO/blah")
        }

        assertThat(file.sanitizedCanonicalPath(), equalTo("/storage/emulated/0/Android/data/org.fsr.collect.android/files/projects/DEMO/blah"))
    }
