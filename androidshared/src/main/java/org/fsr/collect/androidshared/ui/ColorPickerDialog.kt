package org.fsr.collect.androidshared
...
import org.fsr.collect.androidshared.databinding.ColorPickerDialogLayoutBinding
...
class ColorPickerDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            ...
            .setTitle(org.fsr.collect.strings.R.string.project_color)
            .setNegativeButton(org.fsr.collect.strings.R.string.cancel) { _, _ -> dismiss() }
            .setPositiveButton(org.fsr.collect.strings.R.string.ok) { _, _ -> model.pickColor("#${binding.hexColor.text}") }
            .create()
    }
    ...
    private fun updateCurrentColorCircle(color: String) {
        try {
            ...
            binding.hexColor.error = getString(org.fsr.collect.strings.R.string.invalid_hex_code)
            (dialog as? AlertDialog)?.also {
