...
internal object PermissionsDialogCreatorImpl : PermissionsDialogCreator {
    override fun showEnableGPSDialog(
        ...
        MaterialAlertDialogBuilder(activity)
            .setMessage(activity.getString(org.fsr.collect.strings.R.string.gps_enable_message))
            .setCancelable(false)
            .setPositiveButton(
                activity.getString(org.fsr.collect.strings.R.string.enable_gps)
            ...
            .setNegativeButton(
                activity.getString(org.fsr.collect.strings.R.string.cancel)
    ...
    override fun showAdditionalExplanation(
        ...
        MaterialAlertDialogBuilder(activity)
            ...
            .setNeutralButton(org.fsr.collect.strings.R.string.open_settings) { _, _ ->
