        ...
        requestPermissions(
            ...
            object : PermissionListener {
                ...
                override fun denied() {
                    ...
                    permissionsDialogCreator.showAdditionalExplanation(
                        activity,
                        org.fsr.collect.strings.R.string.location_runtime_permissions_denied_title,
                        org.fsr.collect.strings.R.string.location_runtime_permissions_denied_desc,
        ...
        requestPermissions(
            ...
            object : PermissionListener {
                ...
                override fun denied() {
                    ...
                    permissionsDialogCreator.showAdditionalExplanation(
                        activity,
                        org.fsr.collect.strings.R.string.record_audio_runtime_permission_denied_title,
                        org.fsr.collect.strings.R.string.record_audio_runtime_permission_denied_desc,
                        org.fsr.collect.icons.R.drawable.ic_baseline_mic_24,
                        action
                    )
                }
            },
            ...
            requestPermissions(
                ...
                object : PermissionListener {
                    ...
                    override fun denied() {
                        permissionsDialogCreator.showAdditionalExplanation(
                            activity,
                            org.fsr.collect.strings.R.string.storage_runtime_permission_denied_title,
                            org.fsr.collect.strings.R.string.storage_runtime_permission_denied_desc,
