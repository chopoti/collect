...
import org.fsr.collect.lists.databinding.MultiSelectListBinding
...
class MultiSelectListFragment<T, VH : MultiSelectAdapter.ViewHolder<T>>(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        appBarLayout = requireActivity().findViewById(org.fsr.collect.androidshared.R.id.appBarLayout)
