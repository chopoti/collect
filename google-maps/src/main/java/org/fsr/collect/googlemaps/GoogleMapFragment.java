...
import org.fsr.collect.androidshared.system.ContextUtils;
...
import org.fsr.collect.googlemaps.scaleview.MapScaleView;
...
import org.fsr.collect.maps.MapFragmentDelegate;
import org.fsr.collect.maps.MapPoint;
import org.fsr.collect.maps.PolygonDescription;
import org.fsr.collect.maps.layers.MapFragmentReferenceLayerUtils;
...
public class GoogleMapFragment extends Fragment implements
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync((GoogleMap googleMap) -> {
            if (googleMap == null) {
                ToastUtils.showShortToast(requireContext(), org.fsr.collect.strings.R.string.google_play_services_error_occured);
    ...
    private void updateLocationIndicator(LatLng loc, double radius) {
        ...
        if (locationCrosshairs == null) {
            locationCrosshairs = map.addMarker(new MarkerOptions()
                .position(loc)
                .icon(getBitmapDescriptor(getContext(), new MarkerIconDescription(org.fsr.collect.maps.R.drawable.ic_crosshairs)))
        ...
        if (accuracyCircle == null) {
            ...
            int fill = getResources().getColor(org.fsr.collect.androidshared.R.color.color_primary_low_emphasis);
    ...
    private MapConfigurator createConfigurator() {
        return new GoogleMapConfigurator(
                ProjectKeys.KEY_GOOGLE_MAP_STYLE, org.fsr.collect.strings.R.string.basemap_source_google,
    ...
    private static class DynamicPolyLineFeature implements LineFeature {
        ...
        DynamicPolyLineFeature(Context context, LineDescription lineDescription, GoogleMap map) {
            ...
            for (MapPoint point : lineDescription.getPoints()) {
                markers.add(createMarker(context, new MarkerDescription(point, true, CENTER, new MarkerIconDescription(org.fsr.collect.icons.R.drawable.ic_map_point)), map));
            }
