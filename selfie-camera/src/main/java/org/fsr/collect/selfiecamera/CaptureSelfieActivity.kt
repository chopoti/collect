        ...
        camera.state().observe(this) {
            when (it) {
                ...
                Camera.State.FAILED_TO_INITIALIZE -> {
                    showLongToast(this, org.fsr.collect.strings.R.string.camera_failed_to_initialize)
                }
            }
        }
    }
    ...
    private fun setupCamera(camera: Camera) {
        ...
        previewView.setOnClickListener {
            camera.takePicture(
                ...
                { showLongToast(this, org.fsr.collect.strings.R.string.camera_error) }
            )
        }

        showLongToast(this, org.fsr.collect.strings.R.string.take_picture_instruction)
    }
