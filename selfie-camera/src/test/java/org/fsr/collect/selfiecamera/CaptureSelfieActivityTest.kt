...
import org.fsr.collect.selfiecamera.support.RobolectricApplication
...
class CaptureSelfieActivityTest {
    ...
    fun clickingPreview_whenThereIsAnErrorSavingImage_showsToast() {
        ...
        assertThat(latestToast, equalTo(application.getString(org.fsr.collect.strings.R.string.camera_error)))
    }
    ...
    fun whenCameraFailsToInitialize_showsToast() {
        ...
        launcher.launch<CaptureSelfieActivity>(intent)
        val latestToast = ShadowToast.getTextOfLatestToast()
        assertThat(latestToast, equalTo(application.getString(org.fsr.collect.strings.R.string.camera_failed_to_initialize)))
    }
}
