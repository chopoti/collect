...
import org.fsr.collect.audiorecorder.support.FakeRecorder
import org.fsr.collect.audiorecorder.testsupport.RobolectricApplication
import org.fsr.collect.servicetest.ServiceScenario
...
class AudioRecorderServiceTest {
    ...
    fun startAction_startsInForegroundWithNotification() {
        ...
        assertThat(
            ...
            equalTo(application.getString(org.fsr.collect.strings.R.string.recording))
        )
        assertThat(
