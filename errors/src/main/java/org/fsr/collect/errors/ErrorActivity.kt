...
class ErrorActivity : LocalizedActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = getLocalizedString(org.fsr.collect.strings.R.string.errors)
        val toolbar = findViewById<View>(org.fsr.collect.androidshared.R.id.toolbar) as Toolbar
        setSupportActionBar(toolbar)
        supportActionBar!!.setDisplayHomeAsUpEnabled(true)
        findViewById<Toolbar>(org.fsr.collect.androidshared.R.id.toolbar).setNavigationOnClickListener { finish() }
