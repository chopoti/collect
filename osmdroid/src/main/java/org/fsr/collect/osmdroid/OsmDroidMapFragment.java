...
import org.fsr.collect.maps.markers.MarkerIconCreator;
...
public class OsmDroidMapFragment extends Fragment implements MapFragment,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Drawable drawable = ContextCompat.getDrawable(requireActivity(), org.fsr.collect.maps.R.drawable.ic_crosshairs);
    ...
    private class DynamicPolyLineFeature implements LineFeature {
        ...
        DynamicPolyLineFeature(MapView map, LineDescription lineDescription) {
            ...
            for (MapPoint point : lineDescription.getPoints()) {
                markers.add(createMarker(map, new MarkerDescription(point, true, CENTER, new MarkerIconDescription(org.fsr.collect.icons.R.drawable.ic_map_point))));
            }
            update();
        }
